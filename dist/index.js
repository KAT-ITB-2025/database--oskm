import {pgEnum,pgTable,timestamp,text,boolean,integer,serial,primaryKey,real,pgMaterializedView,time}from'drizzle-orm/pg-core';import {init}from'@paralleldrive/cuid2';import {sql,relations}from'drizzle-orm';var a=init({length:8}),r=()=>new Date;var le=pgEnum("accounts_role_enum",["admin","mamet","mentor","user","guest"]),c=pgTable("accounts",{id:text("id").primaryKey().$defaultFn(()=>a()),nim:text("nim").notNull().unique(),password:text("password").notNull(),role:le("role").default("user").notNull(),lastLoggedIn:timestamp("last_logged_in"),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(r)});var fe=pgEnum("media_bucket_enum",["profile","content","documents","uploads"]),_=pgTable("media",{id:text("id").primaryKey().$defaultFn(()=>a()),creatorId:text("creator_id").notNull().references(()=>t.id),name:text("name").notNull(),bucket:fe("bucket").notNull(),type:text("type").notNull(),url:text("url").notNull(),updatedAt:timestamp("updated_at").$onUpdate(r),createdAt:timestamp("created_at").defaultNow()});var t=pgTable("users",{id:text("id").references(()=>c.id).primaryKey(),nim:text("nim").notNull().unique(),email:text("email").unique(),emailVerified:boolean("email_verified").notNull().default(false),fullName:text("full_name"),fakultas:text("fakultas"),keluarga:text("keluarga"),bata:text("bata"),rumpun:text("rumpun"),fotoMediaId:text("foto_media_id").references(()=>_.id),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(r)}),F=pgTable("email_verification_otps",{userId:text("user_id").notNull().references(()=>t.id,{onDelete:"cascade"}),otp:text("otp").notNull(),expiresAt:timestamp("expires_at",{mode:"date",withTimezone:true}).notNull(),createdAt:timestamp("created_at").defaultNow()});var b=pgTable("endpoint_analytics",{id:serial("id").primaryKey(),userId:text("user_id").references(()=>t.id,{onDelete:"set null"}),endpoint:text("endpoint").notNull(),method:text("method").notNull(),statusCode:integer("status_code").notNull(),responseTimeMs:integer("response_time_ms"),urlQuery:text("url_query"),requestBody:text("request_body"),errorMessage:text("error_message"),createdAt:timestamp("created_at").defaultNow()});var P=pgTable("verification_token",{identifier:text("identifier").notNull().references(()=>t.email),token:text("token"),expiredAt:timestamp("expired_at",{mode:"date",withTimezone:true})},e=>[primaryKey({columns:[e.identifier,e.token]})]);var qe=pgEnum("class_enum",["sesi_1","sesi_2"]),E=pgTable("classes",{id:text("id").primaryKey().$defaultFn(()=>a()),className:text("class_name").notNull(),room:text("room").notNull(),totalQuota:integer("total_quota").notNull(),mentorId:text("mentor_id").references(()=>t.id),classType:qe("class_type").notNull(),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(r)}),q=pgTable("class_registrations",{id:text("id").primaryKey().$defaultFn(()=>a()),userId:text("user_id").notNull().references(()=>t.id),classId:text("class_id").notNull().references(()=>E.id),registeredAt:timestamp("registered_at").defaultNow(),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(r)});var s=pgTable("profil_kats",{id:text("id").primaryKey().$defaultFn(()=>a()),profilNumber:integer("profil_number").notNull().unique(),quizWeight:real("quiz_weight").notNull().default(0),assignmentWeight:real("assignment_weight").notNull().default(0),attendanceWeight:real("attendance_weight").notNull().default(0),title:text("title").notNull(),description:text("description")}),w=pgTable("assignments_profil",{id:text("id").primaryKey().$defaultFn(()=>a()),profilKATId:text("profil_kat_id").notNull().references(()=>s.id),title:text("title").notNull(),assignmentMediaId:text("assignment_media_id").notNull().references(()=>_.id),description:text("description"),dueDate:timestamp("due_date",{mode:"date",withTimezone:true}).notNull(),isOpen:boolean("is_open").default(false).notNull(),startDate:timestamp("start_date",{mode:"date",withTimezone:true}).notNull(),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(r)}),f=pgTable("submissions_profil",{id:text("id").primaryKey().$defaultFn(()=>a()),assignmentId:text("assignment_id").notNull().references(()=>w.id),userId:text("user_id").notNull().references(()=>t.id),submissionMediaId:text("submission_media_id").notNull().references(()=>_.id),score:integer("score").default(0).notNull(),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(r)});var ze=pgEnum("status",["completed","not_completed"]),p=pgTable("stages",{id:text("id").primaryKey().$defaultFn(()=>a()),profilId:text("profil_id").notNull().references(()=>s.id),stageNumber:integer("stage_number").notNull(),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(r)}),S=pgTable("user_stage_progress",{id:text("id").primaryKey().$defaultFn(()=>a()),userId:text("user_id").notNull().references(()=>t.id),stageId:text("stage_id").notNull().references(()=>p.id),status:ze("status").notNull(),completedAt:timestamp("completed_at"),quizScore:integer("quiz_score"),updatedAt:timestamp("updated_at").$onUpdate(r)});var Oe=pgEnum("question_type_enum",["multiple_choice","short_answer"]),N=pgTable("questions",{id:text("id").primaryKey().$defaultFn(()=>a()),stageId:text("stage_id").notNull().references(()=>p.id),questionText:text("question_text").notNull(),questionType:Oe("question_type").notNull(),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(r)}),R=pgTable("question_answer_options",{id:text("id").primaryKey().$defaultFn(()=>a()),questionId:text("question_id").notNull().references(()=>N.id),answerText:text("answer_text").notNull(),isCorrect:boolean("is_correct").default(false).notNull(),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(r)});var Ft=pgMaterializedView("user_ranking_view",{userId:text("user_id").primaryKey(),nim:text("nim"),fullName:text("full_name"),fakultas:text("fakultas"),keluarga:text("keluarga"),bata:text("bata"),rumpun:text("rumpun"),fotoMediaId:text("foto_media_id"),profil1QuizWeight:real("profil1_quiz_weight").notNull().default(0),profil1QuizScore:integer("profil1_quiz_score").notNull().default(0),profil1AssignmentWeight:real("profil1_assignment_weight").notNull().default(0),profil1AvgAssignmentScore:real("profil1_avg_assignment_score").notNull().default(0),profil1AttendanceWeight:real("profil1_attendance_weight").notNull().default(0),profil1AvgAttendanceScore:real("profil1_avg_attendance_score").notNull().default(0),profil1TotalScore:real("profil1_total_score").notNull().default(0),profil2QuizWeight:real("profil2_quiz_weight").notNull().default(0),profil2QuizScore:integer("profil2_quiz_score").notNull().default(0),profil2AssignmentWeight:real("profil2_assignment_weight").notNull().default(0),profil2AvgAssignmentScore:real("profil2_avg_assignment_score").notNull().default(0),profil2AttendanceWeight:real("profil2_attendance_weight").notNull().default(0),profil2AvgAttendanceScore:real("profil2_avg_attendance_score").notNull().default(0),profil2TotalScore:real("profil2_total_score").notNull().default(0),profil3QuizWeight:real("profil3_quiz_weight").notNull().default(0),profil3QuizScore:integer("profil3_quiz_score").notNull().default(0),profil3AssignmentWeight:real("profil3_assignment_weight").notNull().default(0),profil3AvgAssignmentScore:real("profil3_avg_assignment_score").notNull().default(0),profil3AttendanceWeight:real("profil3_attendance_weight").notNull().default(0),profil3AvgAttendanceScore:real("profil3_avg_attendance_score").notNull().default(0),profil3TotalScore:real("profil3_total_score").notNull().default(0),profil4QuizWeight:real("profil4_quiz_weight").notNull().default(0),profil4QuizScore:integer("profil4_quiz_score").notNull().default(0),profil4AssignmentWeight:real("profil4_assignment_weight").notNull().default(0),profil4AvgAssignmentScore:real("profil4_avg_assignment_score").notNull().default(0),profil4AttendanceWeight:real("profil4_attendance_weight").notNull().default(0),profil4AvgAttendanceScore:real("profil4_avg_attendance_score").notNull().default(0),profil4TotalScore:real("profil4_total_score").notNull().default(0),profil5QuizWeight:real("profil5_quiz_weight").notNull().default(0),profil5QuizScore:integer("profil5_quiz_score").notNull().default(0),profil5AssignmentWeight:real("profil5_assignment_weight").notNull().default(0),profil5AvgAssignmentScore:real("profil5_avg_assignment_score").notNull().default(0),profil5AttendanceWeight:real("profil5_attendance_weight").notNull().default(0),profil5AvgAttendanceScore:real("profil5_avg_attendance_score").notNull().default(0),profil5TotalScore:real("profil5_total_score").notNull().default(0),totalScore:real("total_score").notNull().default(0),lastActivityAt:timestamp("last_activity_at"),ranking:integer("ranking").notNull()}).as(sql`
  ...
  FROM user_scores
  ORDER BY ranking
`);async function Pt(e){await e.execute(sql`REFRESH MATERIALIZED VIEW user_ranking_view`);}var Kt=sql`
...
`;var ye=pgEnum("attendance_status",["hadir","tidak_hadir"]),Ie=pgEnum("attendance_type",["opening","closing"]),g=pgTable("attendances",{id:text("id").primaryKey().$defaultFn(()=>a()),attendanceType:Ie("attendance_type").notNull(),dayNumber:integer("day_number").notNull(),startTime:timestamp("start_time").notNull(),durationMinutes:integer("duration_minutes").notNull(),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(r)}),O=pgTable("profil_kat_attendance",{id:text("id").primaryKey().$defaultFn(()=>a()),profilKATId:text("profil_kat_id").notNull().references(()=>s.id),attendanceId:text("attendance_id").notNull().references(()=>g.id),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(r)}),H=pgTable("user_attendance",{id:text("id").primaryKey().$defaultFn(()=>a()),scheduleId:text("schedule_id").notNull().references(()=>g.id),userId:text("user_id").notNull().references(()=>t.id),status:ye("status").default("tidak_hadir").notNull(),updatedAt:timestamp("updated_at").$onUpdate(r)});var fi=pgTable("activities",{id:text("id").primaryKey().$defaultFn(()=>a()),day:integer("day").notNull(),title:text("title").notNull(),description:text("description"),startTime:time("start_time").notNull(),endTime:time("end_time").notNull(),location:text("location"),geolocation:text("geolocation"),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(r)});var Si=relations(c,({one:e})=>({user:e(t,{fields:[c.id],references:[t.id]})})),zi=relations(t,({one:e,many:o})=>({account:e(c,{fields:[t.id],references:[c.id]}),fotoMedia:e(_,{fields:[t.fotoMediaId],references:[_.id]}),stageProgress:o(S),attendance:o(H),submissions:o(f),createdMedia:o(_),analytics:o(b),classRegistrations:o(q),mentorClasses:o(E)})),Ti=relations(F,({one:e})=>({user:e(t,{fields:[F.userId],references:[t.id]})})),vi=relations(P,({one:e})=>({user:e(t,{fields:[P.identifier],references:[t.email]})})),Oi=relations(_,({one:e,many:o})=>({creator:e(t,{fields:[_.creatorId],references:[t.id]}),submissions:o(f)})),Hi=relations(g,({many:e})=>({userAttendance:e(H),profilKATAttendances:e(O)})),xi=relations(H,({one:e})=>({attendance:e(g,{fields:[H.scheduleId],references:[g.id]}),user:e(t,{fields:[H.userId],references:[t.id]})})),yi=relations(O,({one:e})=>({profilKAT:e(s,{fields:[O.profilKATId],references:[s.id]}),attendance:e(g,{fields:[O.attendanceId],references:[g.id]})})),Ii=relations(p,({many:e,one:o})=>({userProgress:e(S),questions:e(N),profil:o(s,{fields:[p.profilId],references:[s.id]})})),ki=relations(S,({one:e})=>({user:e(t,{fields:[S.userId],references:[t.id]}),stage:e(p,{fields:[S.stageId],references:[p.id]})})),Li=relations(N,({one:e,many:o})=>({stage:e(p,{fields:[N.stageId],references:[p.id]}),answerOptions:o(R)})),bi=relations(R,({one:e})=>({question:e(N,{fields:[R.questionId],references:[N.id]})})),Di=relations(s,({many:e,one:o})=>({assignments:e(w),attendances:e(O),stage:o(p,{fields:[s.id],references:[p.profilId]})})),Wi=relations(w,({many:e,one:o})=>({submissions:e(f),profil:o(s,{fields:[w.profilKATId],references:[s.id]})})),Ri=relations(f,({one:e})=>({assignment:e(w,{fields:[f.assignmentId],references:[w.id]}),user:e(t,{fields:[f.userId],references:[t.id]}),media:e(_,{fields:[f.submissionMediaId],references:[_.id]})})),Mi=relations(E,({one:e,many:o})=>({mentor:e(t,{fields:[E.mentorId],references:[t.id]}),registrations:o(q)})),Xi=relations(q,({one:e})=>({user:e(t,{fields:[q.userId],references:[t.id]}),class:e(E,{fields:[q.classId],references:[E.id]})})),Fi=relations(b,({one:e})=>({user:e(t,{fields:[b.userId],references:[t.id]})}));export{c as accounts,Si as accountsRelation,le as accountsRoleEnum,fi as activities,w as assignmentsProfil,Wi as assignmentsProfilRelation,ye as attendanceStatusEnum,Ie as attendanceTypeEnum,g as attendances,Hi as attendancesRelation,qe as classEnum,q as classRegistrations,Xi as classRegistrationsRelation,E as classes,Mi as classesRelation,Kt as createUserRankingViewIndexes,F as emailVerificationOtps,Ti as emailVerificationOtpsRelations,b as endpointAnalytics,Fi as endpointAnalyticsRelation,_ as media,fe as mediaBucketEnum,Oi as mediaRelation,O as profilKATAttendances,yi as profilKATAttendancesRelation,s as profilKATs,Di as profilKATsRelation,R as questionAnswerOptions,bi as questionAnswerOptionsRelation,Oe as questionTypeEnum,N as questions,Li as questionsRelation,Pt as refreshUserRankingView,ze as stageStatusEnum,p as stages,Ii as stagesRelation,f as submissionsProfil,Ri as submissionsProfilRelation,H as userAttendance,xi as userAttendanceRelation,Ft as userRankingView,S as userStageProgress,ki as userStageProgressRelation,t as users,zi as usersRelation,P as verificationToken,vi as verificationTokenRelations};