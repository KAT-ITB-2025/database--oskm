...
`;var $e=pgEnum("attendance_status",["hadir","tidak_hadir"]),Ge=pgEnum("attendance_type",["opening","closing"]),m=pgTable("attendances",{id:text("id").primaryKey().$defaultFn(()=>s()),attendanceType:Ge("attendance_type").notNull(),dayNumber:integer("day_number").notNull(),startTime:timestamp("start_time",{mode:"date",withTimezone:true}).notNull(),durationMinutes:integer("duration_minutes").notNull(),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(a)}),L=pgTable("profil_kat_attendance",{id:text("id").primaryKey().$defaultFn(()=>s()),profilKATId:text("profil_kat_id").notNull().references(()=>_.id),attendanceId:text("attendance_id").notNull().references(()=>m.id),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(a)}),I=pgTable("user_attendance",{id:text("id").primaryKey().$defaultFn(()=>s()),scheduleId:text("schedule_id").notNull().references(()=>m.id),userId:text("user_id").notNull().references(()=>t.id),status:$e("status").default("tidak_hadir").notNull(),updatedAt:timestamp("updated_at").$onUpdate(a)});var Ve=pgEnum("itb_guesser_tempat",["Ganesha","Jatinangor","Cirebon"]),y=pgTable("itb_guesser_options",{id:text("id").primaryKey().$defaultFn(()=>s()),tempat:Ve("tempat").notNull(),publicUrl:text("public_url").notNull(),lat:real("lat").notNull(),lng:real("lng").notNull(),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(a)}),k=pgTable("itb_guesser_submissions",{id:text("id").primaryKey().$defaultFn(()=>s()),userId:text("user_id").notNull().references(()=>t.id),optionId:text("option_id").notNull().references(()=>y.id),answerLat:real("answer_lat").notNull(),answerLng:real("answer_lng").notNull(),score:real("score").notNull(),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(a)}),Ti=pgTable("memory_game_scores",{id:text("id").primaryKey().$defaultFn(()=>s()),userId:text("user_id").notNull().unique().references(()=>t.id),score:integer("score").notNull(),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(a)});var ie=pgTable("handbook",{mediaId:text("media_id").primaryKey().references(()=>n.id),title:text("title")});var Fi=pgTable("activities",{id:text("id").primaryKey().$defaultFn(()=>s()),day:integer("day").notNull(),title:text("title").notNull(),description:text("description"),startTime:time("start_time").notNull(),endTime:time("end_time").notNull(),location:text("location"),lat:real("lat"),lng:real("lng"),createdAt:timestamp("created_at").defaultNow(),updatedAt:timestamp("updated_at").$onUpdate(a)});var g=pgTable("user_matches",{id:text("id").primaryKey().$defaultFn(createId),topic:text("topic").notNull(),isActive:boolean("is_active").notNull().default(true),isAnonymous:boolean("is_anonymous").notNull().default(true),isRevealed:boolean("is_revealed").notNull().default(false),firstUserId:text("first_user_id").notNull().references(()=>t.id,{onDelete:"cascade"}),secondUserId:text("second_user_id").notNull().references(()=>t.id,{onDelete:"cascade"}),lastMessage:text("last_message"),createdAt:timestamp("created_at").notNull().defaultNow()}),D=pgTable("messages",{id:bigserial("id",{mode:"number"}).primaryKey(),userMatchId:text("user_match_id").notNull().references(()=>g.id,{onDelete:"cascade"}),senderId:text("sender_id").notNull().references(()=>t.id,{onDelete:"cascade"}),content:text("content").notNull(),createdAt:timestamp("created_at",{mode:"date",withTimezone:true}).notNull().defaultNow()});var nr=relations(N,({one:e})=>({user:e(t,{fields:[N.id],references:[t.id]})})),_r=relations(t,({one:e,many:r})=>({account:e(N,{fields:[t.id],references:[N.id]}),fotoMedia:e(n,{fields:[t.fotoMediaId],references:[n.id]}),stageProgress:r(O),attendance:r(I),submissions:r(c),createdMedia:r(n),analytics:r(F),classRegistrations:r(T),userMatchesAsFirstUser:r(g,{relationName:"first_user"}),userMatchesAsSecondUser:r(g,{relationName:"second_user"}),messages:r(D,{relationName:"sender"}),itbGuesserSubmissions:r(k)})),lr=relations(B,({one:e})=>({user:e(t,{fields:[B.userId],references:[t.id]})})),ur=relations(Y,({one:e})=>({user:e(t,{fields:[Y.identifier],references:[t.email]})})),pr=relations(n,({one:e,many:r})=>({creator:e(t,{fields:[n.creatorId],references:[t.id]}),handbook:e(ie,{fields:[n.id],references:[ie.mediaId]}),submissions:r(c),itbGuesserOptions:r(y)})),fr=relations(m,({many:e})=>({userAttendance:e(I),profilKATAttendances:e(L)})),gr=relations(I,({one:e})=>({attendance:e(m,{fields:[I.scheduleId],references:[m.id]}),user:e(t,{fields:[I.userId],references:[t.id]})})),dr=relations(L,({one:e})=>({profilKAT:e(_,{fields:[L.profilKATId],references:[_.id]}),attendance:e(m,{fields:[L.attendanceId],references:[m.id]})})),cr=relations(u,({many:e,one:r})=>({userProgress:e(O),questions:e(h),profil:r(_,{fields:[u.profilId],references:[_.id]})})),mr=relations(O,({one:e})=>({user:e(t,{fields:[O.userId],references:[t.id]}),stage:e(u,{fields:[O.stageId],references:[u.id]})})),Er=relations(h,({one:e,many:r})=>({stage:e(u,{fields:[h.stageId],references:[u.id]}),answerOptions:r(G)})),Nr=relations(G,({one:e})=>({question:e(h,{fields:[G.questionId],references:[h.id]})})),wr=relations(_,({many:e,one:r})=>({assignments:e(w),attendances:e(L),stage:r(u,{fields:[_.id],references:[u.profilId]})})),hr=relations(w,({many:e,one:r})=>({submissions:e(c),profil:r(_,{fields:[w.profilKATId],references:[_.id]})})),Ar=relations(c,({one:e})=>({assignment:e(w,{fields:[c.assignmentId],references:[w.id]}),user:e(t,{fields:[c.userId],references:[t.id]}),media:e(n,{fields:[c.submissionMediaId],references:[n.id]})})),Cr=relations(M,({one:e,many:r})=>({registrations:r(T)})),Sr=relations(T,({one:e})=>({user:e(t,{fields:[T.userId],references:[t.id]}),class:e(M,{fields:[T.classId],references:[M.id]})})),qr=relations(F,({one:e})=>({user:e(t,{fields:[F.userId],references:[t.id]})})),Tr=relations(g,({many:e,one:r})=>({firstUser:r(t,{fields:[g.firstUserId],references:[t.id],relationName:"first_user"}),secondUser:r(t,{fields:[g.secondUserId],references:[t.id],relationName:"second_user"}),messages:e(D)})),zr=relations(D,({one:e})=>({senderId:e(t,{fields:[D.senderId],references:[t.id],relationName:"sender"}),userMatch:e(g,{fields:[D.userMatchId],references:[g.id]})})),Or=relations(y,({one:e,many:r})=>({submissions:r(k)})),br=relations(k,({one:e})=>({user:e(t,{fields:[k.userId],references:[t.id]}),option:e(y,{fields:[k.optionId],references:[y.id]})}));export{N as accounts,nr as accountsRelation,Te as accountsRoleEnum,Fi as activities,w as assignmentsProfil,hr as assignmentsProfilRelation,$e as attendanceStatusEnum,Ge as attendanceTypeEnum,m as attendances,fr as attendancesRelation,De as classEnum,T as classRegistrations,Sr as classRegistrationsRelation,M as classes,Cr as classesRelation,li as createUserRankingViewIndexes,B as emailVerificationOtps,lr as emailVerificationOtpsRelations,F as endpointAnalytics,qr as endpointAnalyticsRelation,ie as handbook,y as itbGuesserOptions,Or as itbGuesserOptionsRelations,k as itbGuesserSubmissions,br as itbGuesserSubmissionsRelations,Ve as itbGuesserTempatEnum,n as media,pr as mediaRelation,Ti as memoryGameScores,D as messages,zr as messagesRelations,L as profilKATAttendances,dr as profilKATAttendancesRelation,_ as profilKATs,wr as profilKATsRelation,G as questionAnswerOptions,Nr as questionAnswerOptionsRelation,Fe as questionTypeEnum,h as questions,Er as questionsRelation,_i as refreshUserRankingView,Re as stageStatusEnum,u as stages,cr as stagesRelation,c as submissionsProfil,Ar as submissionsProfilRelation,I as userAttendance,gr as userAttendanceRelation,g as userMatches,Tr as userMatchesRelations,ni as userRankingView,O as userStageProgress,mr as userStageProgressRelation,t as users,_r as usersRelation,Y as verificationToken,ur as verificationTokenRelations};