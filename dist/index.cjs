...
`;var ye=pgCore.pgEnum("attendance_status",["hadir","tidak_hadir"]),Ie=pgCore.pgEnum("attendance_type",["opening","closing"]),g=pgCore.pgTable("attendances",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),attendanceType:Ie("attendance_type").notNull(),dayNumber:pgCore.integer("day_number").notNull(),startTime:pgCore.timestamp("start_time").notNull(),durationMinutes:pgCore.integer("duration_minutes").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),O=pgCore.pgTable("profil_kat_attendance",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),profilKATId:pgCore.text("profil_kat_id").notNull().references(()=>s.id),attendanceId:pgCore.text("attendance_id").notNull().references(()=>g.id),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),H=pgCore.pgTable("user_attendance",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),scheduleId:pgCore.text("schedule_id").notNull().references(()=>g.id),userId:pgCore.text("user_id").notNull().references(()=>t.id),status:ye("status").default("tidak_hadir").notNull(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var fi=pgCore.pgTable("activities",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),day:pgCore.integer("day").notNull(),title:pgCore.text("title").notNull(),description:pgCore.text("description"),startTime:pgCore.time("start_time").notNull(),endTime:pgCore.time("end_time").notNull(),location:pgCore.text("location"),geolocation:pgCore.text("geolocation"),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var Si=drizzleOrm.relations(c,({one:e})=>({user:e(t,{fields:[c.id],references:[t.id]})})),zi=drizzleOrm.relations(t,({one:e,many:o})=>({account:e(c,{fields:[t.id],references:[c.id]}),fotoMedia:e(_,{fields:[t.fotoMediaId],references:[_.id]}),stageProgress:o(S),attendance:o(H),submissions:o(f),createdMedia:o(_),analytics:o(b),classRegistrations:o(q),mentorClasses:o(E)})),Ti=drizzleOrm.relations(F,({one:e})=>({user:e(t,{fields:[F.userId],references:[t.id]})})),vi=drizzleOrm.relations(P,({one:e})=>({user:e(t,{fields:[P.identifier],references:[t.email]})})),Oi=drizzleOrm.relations(_,({one:e,many:o})=>({creator:e(t,{fields:[_.creatorId],references:[t.id]}),submissions:o(f)})),Hi=drizzleOrm.relations(g,({many:e})=>({userAttendance:e(H),profilKATAttendances:e(O)})),xi=drizzleOrm.relations(H,({one:e})=>({attendance:e(g,{fields:[H.scheduleId],references:[g.id]}),user:e(t,{fields:[H.userId],references:[t.id]})})),yi=drizzleOrm.relations(O,({one:e})=>({profilKAT:e(s,{fields:[O.profilKATId],references:[s.id]}),attendance:e(g,{fields:[O.attendanceId],references:[g.id]})})),Ii=drizzleOrm.relations(p,({many:e,one:o})=>({userProgress:e(S),questions:e(N),profil:o(s,{fields:[p.profilId],references:[s.id]})})),ki=drizzleOrm.relations(S,({one:e})=>({user:e(t,{fields:[S.userId],references:[t.id]}),stage:e(p,{fields:[S.stageId],references:[p.id]})})),Li=drizzleOrm.relations(N,({one:e,many:o})=>({stage:e(p,{fields:[N.stageId],references:[p.id]}),answerOptions:o(R)})),bi=drizzleOrm.relations(R,({one:e})=>({question:e(N,{fields:[R.questionId],references:[N.id]})})),Di=drizzleOrm.relations(s,({many:e,one:o})=>({assignments:e(w),attendances:e(O),stage:o(p,{fields:[s.id],references:[p.profilId]})})),Wi=drizzleOrm.relations(w,({many:e,one:o})=>({submissions:e(f),profil:o(s,{fields:[w.profilKATId],references:[s.id]})})),Ri=drizzleOrm.relations(f,({one:e})=>({assignment:e(w,{fields:[f.assignmentId],references:[w.id]}),user:e(t,{fields:[f.userId],references:[t.id]}),media:e(_,{fields:[f.submissionMediaId],references:[_.id]})})),Mi=drizzleOrm.relations(E,({one:e,many:o})=>({mentor:e(t,{fields:[E.mentorId],references:[t.id]}),registrations:o(q)})),Xi=drizzleOrm.relations(q,({one:e})=>({user:e(t,{fields:[q.userId],references:[t.id]}),class:e(E,{fields:[q.classId],references:[E.id]})})),Fi=drizzleOrm.relations(b,({one:e})=>({user:e(t,{fields:[b.userId],references:[t.id]})}));exports.accounts=c;exports.accountsRelation=Si;exports.accountsRoleEnum=le;exports.activities=fi;exports.assignmentsProfil=w;exports.assignmentsProfilRelation=Wi;exports.attendanceStatusEnum=ye;exports.attendanceTypeEnum=Ie;exports.attendances=g;exports.attendancesRelation=Hi;exports.classEnum=qe;exports.classRegistrations=q;exports.classRegistrationsRelation=Xi;exports.classes=E;exports.classesRelation=Mi;exports.createUserRankingViewIndexes=Kt;exports.emailVerificationOtps=F;exports.emailVerificationOtpsRelations=Ti;exports.endpointAnalytics=b;exports.endpointAnalyticsRelation=Fi;exports.media=_;exports.mediaBucketEnum=fe;exports.mediaRelation=Oi;exports.profilKATAttendances=O;exports.profilKATAttendancesRelation=yi;exports.profilKATs=s;exports.profilKATsRelation=Di;exports.questionAnswerOptions=R;exports.questionAnswerOptionsRelation=bi;exports.questionTypeEnum=Oe;exports.questions=N;exports.questionsRelation=Li;exports.refreshUserRankingView=Pt;exports.stageStatusEnum=ze;exports.stages=p;exports.stagesRelation=Ii;exports.submissionsProfil=f;exports.submissionsProfilRelation=Ri;exports.userAttendance=H;exports.userAttendanceRelation=xi;exports.userRankingView=Ft;exports.userStageProgress=S;exports.userStageProgressRelation=ki;exports.users=t;exports.usersRelation=zi;exports.verificationToken=P;exports.verificationTokenRelations=vi;