'use strict';var pgCore=require('drizzle-orm/pg-core'),cuid2=require('@paralleldrive/cuid2'),drizzleOrm=require('drizzle-orm');var o=cuid2.init({length:8}),a=()=>new Date;var Ne=pgCore.pgEnum("accounts_role_enum",["admin","mamet","mentor","user","guest","hr"]),E=pgCore.pgTable("accounts",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),nim:pgCore.text("nim").notNull().unique(),password:pgCore.text("password").notNull(),role:Ne("role").default("user").notNull(),lastLoggedIn:pgCore.timestamp("last_logged_in"),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)});var n=pgCore.pgTable("media",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),creatorId:pgCore.text("creator_id").references(()=>t.id),name:pgCore.text("name").notNull(),bucket:pgCore.text("bucket").notNull(),type:pgCore.text("type").notNull(),url:pgCore.text("url").notNull(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a),createdAt:pgCore.timestamp("created_at").defaultNow()});var t=pgCore.pgTable("users",{id:pgCore.text("id").references(()=>E.id).primaryKey(),nim:pgCore.text("nim").notNull().unique(),email:pgCore.text("email").unique(),emailVerified:pgCore.boolean("email_verified").notNull().default(false),fullName:pgCore.text("full_name"),fakultas:pgCore.text("fakultas"),keluarga:pgCore.text("keluarga"),bata:pgCore.text("bata"),rumpun:pgCore.text("rumpun"),fotoMediaId:pgCore.text("foto_media_id").references(()=>n.id),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)}),$=pgCore.pgTable("email_verification_otps",{userId:pgCore.text("user_id").notNull().references(()=>t.id,{onDelete:"cascade"}),otp:pgCore.text("otp").notNull(),expiresAt:pgCore.timestamp("expires_at",{mode:"date",withTimezone:true}).notNull(),createdAt:pgCore.timestamp("created_at").defaultNow()});var W=pgCore.pgTable("endpoint_analytics",{id:pgCore.serial("id").primaryKey(),userId:pgCore.text("user_id").references(()=>t.id,{onDelete:"set null"}),endpoint:pgCore.text("endpoint").notNull(),method:pgCore.text("method").notNull(),statusCode:pgCore.integer("status_code").notNull(),responseTimeMs:pgCore.integer("response_time_ms"),urlQuery:pgCore.text("url_query"),requestBody:pgCore.text("request_body"),errorMessage:pgCore.text("error_message"),createdAt:pgCore.timestamp("created_at").defaultNow()});var J=pgCore.pgTable("verification_token",{identifier:pgCore.text("identifier").notNull().references(()=>t.email),token:pgCore.text("token").notNull(),expiredAt:pgCore.timestamp("expired_at",{mode:"date",withTimezone:true})},e=>[pgCore.primaryKey({columns:[e.identifier,e.token]})]);var ve=pgCore.pgEnum("class_enum",["sesi_1","sesi_2"]),D=pgCore.pgTable("classes",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),className:pgCore.text("class_name").notNull(),room:pgCore.text("room").notNull(),totalQuota:pgCore.integer("total_quota").notNull(),mentorName:pgCore.text("mentor_name").notNull(),classType:ve("class_type").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)}),T=pgCore.pgTable("class_registrations",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),userId:pgCore.text("user_id").notNull().references(()=>t.id),classId:pgCore.text("class_id").notNull().references(()=>D.id),registeredAt:pgCore.timestamp("registered_at").defaultNow(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)});var _=pgCore.pgTable("profil_kats",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),profilNumber:pgCore.integer("profil_number").notNull().unique(),stageWeight:pgCore.real("stage_weight").notNull().default(0),quizWeight:pgCore.real("quiz_weight").notNull().default(0),assignmentWeight:pgCore.real("assignment_weight").notNull().default(0),attendanceWeight:pgCore.real("attendance_weight").notNull().default(0),title:pgCore.text("title").notNull(),description:pgCore.text("description")}),h=pgCore.pgTable("assignments_profil",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),profilKATId:pgCore.text("profil_kat_id").notNull().references(()=>_.id),title:pgCore.text("title").notNull(),assignmentMediaId:pgCore.text("assignment_media_id").references(()=>n.id),description:pgCore.text("description"),dueDate:pgCore.timestamp("due_date",{mode:"date",withTimezone:true}).notNull(),isOpen:pgCore.boolean("is_open").default(false).notNull(),startDate:pgCore.timestamp("start_date",{mode:"date",withTimezone:true}).notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)}),g=pgCore.pgTable("submissions_profil",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),assignmentId:pgCore.text("assignment_id").notNull().references(()=>h.id),userId:pgCore.text("user_id").notNull().references(()=>t.id),submissionMediaId:pgCore.text("submission_media_id").notNull().references(()=>n.id),score:pgCore.integer("score").default(0).notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)});var Ie=pgCore.pgEnum("status",["completed","not_completed"]),p=pgCore.pgTable("stages",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),profilId:pgCore.text("profil_id").notNull().references(()=>_.id),stageNumber:pgCore.integer("stage_number").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)}),O=pgCore.pgTable("user_stage_progress",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),userId:pgCore.text("user_id").notNull().references(()=>t.id),stageId:pgCore.text("stage_id").notNull().references(()=>p.id),status:Ie("status").notNull(),completedAt:pgCore.timestamp("completed_at"),quizScore:pgCore.integer("quiz_score"),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)});var xe=pgCore.pgEnum("question_type_enum",["multiple_choice","short_answer"]),w=pgCore.pgTable("questions",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),stageId:pgCore.text("stage_id").notNull().references(()=>p.id),questionText:pgCore.text("question_text").notNull(),questionType:xe("question_type").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)}),U=pgCore.pgTable("question_answer_options",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),questionId:pgCore.text("question_id").notNull().references(()=>w.id),answerText:pgCore.text("answer_text").notNull(),isCorrect:pgCore.boolean("is_correct").default(false).notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)});var Bt=pgCore.pgMaterializedView("user_ranking_view",{userId:pgCore.text("user_id").primaryKey(),nim:pgCore.text("nim"),fullName:pgCore.text("full_name"),fakultas:pgCore.text("fakultas"),keluarga:pgCore.text("keluarga"),bata:pgCore.text("bata"),rumpun:pgCore.text("rumpun"),fotoMediaId:pgCore.text("foto_media_id"),profil1QuizWeight:pgCore.real("profil1_quiz_weight").notNull().default(0),profil1QuizScore:pgCore.integer("profil1_quiz_score").notNull().default(0),profil1AssignmentWeight:pgCore.real("profil1_assignment_weight").notNull().default(0),profil1AvgAssignmentScore:pgCore.real("profil1_avg_assignment_score").notNull().default(0),profil1AttendanceWeight:pgCore.real("profil1_attendance_weight").notNull().default(0),profil1AvgAttendanceScore:pgCore.real("profil1_avg_attendance_score").notNull().default(0),profil1TotalScore:pgCore.real("profil1_total_score").notNull().default(0),profil2QuizWeight:pgCore.real("profil2_quiz_weight").notNull().default(0),profil2QuizScore:pgCore.integer("profil2_quiz_score").notNull().default(0),profil2AssignmentWeight:pgCore.real("profil2_assignment_weight").notNull().default(0),profil2AvgAssignmentScore:pgCore.real("profil2_avg_assignment_score").notNull().default(0),profil2AttendanceWeight:pgCore.real("profil2_attendance_weight").notNull().default(0),profil2AvgAttendanceScore:pgCore.real("profil2_avg_attendance_score").notNull().default(0),profil2TotalScore:pgCore.real("profil2_total_score").notNull().default(0),profil3QuizWeight:pgCore.real("profil3_quiz_weight").notNull().default(0),profil3QuizScore:pgCore.integer("profil3_quiz_score").notNull().default(0),profil3AssignmentWeight:pgCore.real("profil3_assignment_weight").notNull().default(0),profil3AvgAssignmentScore:pgCore.real("profil3_avg_assignment_score").notNull().default(0),profil3AttendanceWeight:pgCore.real("profil3_attendance_weight").notNull().default(0),profil3AvgAttendanceScore:pgCore.real("profil3_avg_attendance_score").notNull().default(0),profil3TotalScore:pgCore.real("profil3_total_score").notNull().default(0),profil4QuizWeight:pgCore.real("profil4_quiz_weight").notNull().default(0),profil4QuizScore:pgCore.integer("profil4_quiz_score").notNull().default(0),profil4AssignmentWeight:pgCore.real("profil4_assignment_weight").notNull().default(0),profil4AvgAssignmentScore:pgCore.real("profil4_avg_assignment_score").notNull().default(0),profil4AttendanceWeight:pgCore.real("profil4_attendance_weight").notNull().default(0),profil4AvgAttendanceScore:pgCore.real("profil4_avg_attendance_score").notNull().default(0),profil4TotalScore:pgCore.real("profil4_total_score").notNull().default(0),profil5QuizWeight:pgCore.real("profil5_quiz_weight").notNull().default(0),profil5QuizScore:pgCore.integer("profil5_quiz_score").notNull().default(0),profil5AssignmentWeight:pgCore.real("profil5_assignment_weight").notNull().default(0),profil5AvgAssignmentScore:pgCore.real("profil5_avg_assignment_score").notNull().default(0),profil5AttendanceWeight:pgCore.real("profil5_attendance_weight").notNull().default(0),profil5AvgAttendanceScore:pgCore.real("profil5_avg_attendance_score").notNull().default(0),profil5TotalScore:pgCore.real("profil5_total_score").notNull().default(0),totalScore:pgCore.real("total_score").notNull().default(0),totalWeightedScore:pgCore.real("total_weighted_score").notNull().default(0),tiebreakerScore:pgCore.real("tiebreaker_score").notNull().default(0),lastActivityAt:pgCore.timestamp("last_activity_at"),attendanceTotal:pgCore.integer("attendance_total").notNull().default(0),ranking:pgCore.integer("ranking").notNull()}).as(drizzleOrm.sql`
  ...
  FROM user_scores
  ORDER BY ranking
`);async function Yt(e){await e.execute(drizzleOrm.sql`REFRESH MATERIALIZED VIEW CONCURRENTLY user_ranking_view`);}var Zt=drizzleOrm.sql`
...
`;var Me=pgCore.pgEnum("attendance_status",["hadir","tidak_hadir"]),Re=pgCore.pgEnum("attendance_type",["opening","closing"]),c=pgCore.pgTable("attendances",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),attendanceType:Re("attendance_type").notNull(),dayNumber:pgCore.integer("day_number").notNull(),startTime:pgCore.timestamp("start_time",{mode:"date",withTimezone:true}).notNull(),durationMinutes:pgCore.integer("duration_minutes").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)}),b=pgCore.pgTable("profil_kat_attendance",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),profilKATId:pgCore.text("profil_kat_id").notNull().references(()=>_.id),attendanceId:pgCore.text("attendance_id").notNull().references(()=>c.id),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)}),L=pgCore.pgTable("user_attendance",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),scheduleId:pgCore.text("schedule_id").notNull().references(()=>c.id),userId:pgCore.text("user_id").notNull().references(()=>t.id),status:Me("status").default("tidak_hadir").notNull(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)});var B=pgCore.pgTable("handbook",{mediaId:pgCore.text("media_id").primaryKey().references(()=>n.id),title:pgCore.text("title")});var Ti=pgCore.pgTable("activities",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),day:pgCore.integer("day").notNull(),title:pgCore.text("title").notNull(),description:pgCore.text("description"),startTime:pgCore.time("start_time").notNull(),endTime:pgCore.time("end_time").notNull(),location:pgCore.text("location"),lat:pgCore.integer("lat"),lng:pgCore.integer("lng"),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)});var f=pgCore.pgTable("user_matches",{id:pgCore.text("id").primaryKey().$defaultFn(cuid2.createId),topic:pgCore.text("topic").notNull(),isActive:pgCore.boolean("is_active").notNull().default(true),isAnonymous:pgCore.boolean("is_anonymous").notNull().default(true),isRevealed:pgCore.boolean("is_revealed").notNull().default(false),firstUserId:pgCore.text("first_user_id").notNull().references(()=>t.id,{onDelete:"cascade"}),secondUserId:pgCore.text("second_user_id").notNull().references(()=>t.id,{onDelete:"cascade"}),lastMessage:pgCore.text("last_message"),createdAt:pgCore.timestamp("created_at").defaultNow()}),I=pgCore.pgTable("messages",{id:pgCore.bigserial("id",{mode:"number"}).primaryKey(),userMatchId:pgCore.text("user_match_id").notNull().references(()=>f.id,{onDelete:"cascade"}),senderId:pgCore.text("sender_id").notNull().references(()=>t.id,{onDelete:"cascade"}),content:pgCore.text("content").notNull(),createdAt:pgCore.timestamp("created_at",{mode:"date",withTimezone:true})});var Ki=drizzleOrm.relations(E,({one:e})=>({user:e(t,{fields:[E.id],references:[t.id]})})),$i=drizzleOrm.relations(t,({one:e,many:r})=>({account:e(E,{fields:[t.id],references:[E.id]}),fotoMedia:e(n,{fields:[t.fotoMediaId],references:[n.id]}),stageProgress:r(O),attendance:r(L),submissions:r(g),createdMedia:r(n),analytics:r(W),classRegistrations:r(T),userMatchesAsFirstUser:r(f,{relationName:"first_user"}),userMatchesAsSecondUser:r(f,{relationName:"second_user"}),messages:r(I,{relationName:"sender"})})),Ji=drizzleOrm.relations($,({one:e})=>({user:e(t,{fields:[$.userId],references:[t.id]})})),Gi=drizzleOrm.relations(J,({one:e})=>({user:e(t,{fields:[J.identifier],references:[t.email]})})),Qi=drizzleOrm.relations(n,({one:e,many:r})=>({creator:e(t,{fields:[n.creatorId],references:[t.id]}),handbook:e(B,{fields:[n.id],references:[B.mediaId]}),submissions:r(g)})),Vi=drizzleOrm.relations(c,({many:e})=>({userAttendance:e(L),profilKATAttendances:e(b)})),Bi=drizzleOrm.relations(L,({one:e})=>({attendance:e(c,{fields:[L.scheduleId],references:[c.id]}),user:e(t,{fields:[L.userId],references:[t.id]})})),Yi=drizzleOrm.relations(b,({one:e})=>({profilKAT:e(_,{fields:[b.profilKATId],references:[_.id]}),attendance:e(c,{fields:[b.attendanceId],references:[c.id]})})),Zi=drizzleOrm.relations(p,({many:e,one:r})=>({userProgress:e(O),questions:e(w),profil:r(_,{fields:[p.profilId],references:[_.id]})})),ji=drizzleOrm.relations(O,({one:e})=>({user:e(t,{fields:[O.userId],references:[t.id]}),stage:e(p,{fields:[O.stageId],references:[p.id]})})),er=drizzleOrm.relations(w,({one:e,many:r})=>({stage:e(p,{fields:[w.stageId],references:[p.id]}),answerOptions:r(U)})),tr=drizzleOrm.relations(U,({one:e})=>({question:e(w,{fields:[U.questionId],references:[w.id]})})),ir=drizzleOrm.relations(_,({many:e,one:r})=>({assignments:e(h),attendances:e(b),stage:r(p,{fields:[_.id],references:[p.profilId]})})),rr=drizzleOrm.relations(h,({many:e,one:r})=>({submissions:e(g),profil:r(_,{fields:[h.profilKATId],references:[_.id]})})),ar=drizzleOrm.relations(g,({one:e})=>({assignment:e(h,{fields:[g.assignmentId],references:[h.id]}),user:e(t,{fields:[g.userId],references:[t.id]}),media:e(n,{fields:[g.submissionMediaId],references:[n.id]})})),or=drizzleOrm.relations(D,({one:e,many:r})=>({registrations:r(T)})),sr=drizzleOrm.relations(T,({one:e})=>({user:e(t,{fields:[T.userId],references:[t.id]}),class:e(D,{fields:[T.classId],references:[D.id]})})),nr=drizzleOrm.relations(W,({one:e})=>({user:e(t,{fields:[W.userId],references:[t.id]})})),_r=drizzleOrm.relations(f,({many:e,one:r})=>({firstUser:r(t,{fields:[f.firstUserId],references:[t.id],relationName:"first_user"}),secondUser:r(t,{fields:[f.secondUserId],references:[t.id],relationName:"second_user"}),messages:e(I)})),lr=drizzleOrm.relations(I,({one:e})=>({senderId:e(t,{fields:[I.senderId],references:[t.id],relationName:"sender"}),userMatch:e(f,{fields:[I.userMatchId],references:[f.id]})}));exports.accounts=E;exports.accountsRelation=Ki;exports.accountsRoleEnum=Ne;exports.activities=Ti;exports.assignmentsProfil=h;exports.assignmentsProfilRelation=rr;exports.attendanceStatusEnum=Me;exports.attendanceTypeEnum=Re;exports.attendances=c;exports.attendancesRelation=Vi;exports.classEnum=ve;exports.classRegistrations=T;exports.classRegistrationsRelation=sr;exports.classes=D;exports.classesRelation=or;exports.createUserRankingViewIndexes=Zt;exports.emailVerificationOtps=$;exports.emailVerificationOtpsRelations=Ji;exports.endpointAnalytics=W;exports.endpointAnalyticsRelation=nr;exports.handbook=B;exports.media=n;exports.mediaRelation=Qi;exports.messages=I;exports.messagesRelations=lr;exports.profilKATAttendances=b;exports.profilKATAttendancesRelation=Yi;exports.profilKATs=_;exports.profilKATsRelation=ir;exports.questionAnswerOptions=U;exports.questionAnswerOptionsRelation=tr;exports.questionTypeEnum=xe;exports.questions=w;exports.questionsRelation=er;exports.refreshUserRankingView=Yt;exports.stageStatusEnum=Ie;exports.stages=p;exports.stagesRelation=Zi;exports.submissionsProfil=g;exports.submissionsProfilRelation=ar;exports.userAttendance=L;exports.userAttendanceRelation=Bi;exports.userMatches=f;exports.userMatchesRelations=_r;exports.userRankingView=Bt;exports.userStageProgress=O;exports.userStageProgressRelation=ji;exports.users=t;exports.usersRelation=$i;exports.verificationToken=J;exports.verificationTokenRelations=Gi;