'use strict';var pgCore=require('drizzle-orm/pg-core'),cuid2=require('@paralleldrive/cuid2'),drizzleOrm=require('drizzle-orm');var a=cuid2.init({length:8}),r=()=>new Date;var le=pgCore.pgEnum("accounts_role_enum",["admin","mamet","mentor","user","guest"]),c=pgCore.pgTable("accounts",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),nim:pgCore.text("nim").notNull().unique(),password:pgCore.text("password").notNull(),role:le("role").default("user").notNull(),lastLoggedIn:pgCore.timestamp("last_logged_in"),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var fe=pgCore.pgEnum("media_bucket_enum",["profile","content","documents","uploads"]),_=pgCore.pgTable("media",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),creatorId:pgCore.text("creator_id").notNull().references(()=>t.id),name:pgCore.text("name").notNull(),bucket:fe("bucket").notNull(),type:pgCore.text("type").notNull(),url:pgCore.text("url").notNull(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r),createdAt:pgCore.timestamp("created_at").defaultNow()});var t=pgCore.pgTable("users",{id:pgCore.text("id").references(()=>c.id).primaryKey(),nim:pgCore.text("nim").notNull().unique(),email:pgCore.text("email").unique(),emailVerified:pgCore.boolean("email_verified").notNull().default(false),fullName:pgCore.text("full_name"),fakultas:pgCore.text("fakultas"),keluarga:pgCore.text("keluarga"),bata:pgCore.text("bata"),rumpun:pgCore.text("rumpun"),fotoMediaId:pgCore.text("foto_media_id").references(()=>_.id),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),F=pgCore.pgTable("email_verification_otps",{userId:pgCore.text("user_id").notNull().references(()=>t.id,{onDelete:"cascade"}),otp:pgCore.text("otp").notNull(),expiresAt:pgCore.timestamp("expires_at",{mode:"date",withTimezone:true}).notNull(),createdAt:pgCore.timestamp("created_at").defaultNow()});var b=pgCore.pgTable("endpoint_analytics",{id:pgCore.serial("id").primaryKey(),userId:pgCore.text("user_id").references(()=>t.id,{onDelete:"set null"}),endpoint:pgCore.text("endpoint").notNull(),method:pgCore.text("method").notNull(),statusCode:pgCore.integer("status_code").notNull(),responseTimeMs:pgCore.integer("response_time_ms"),urlQuery:pgCore.text("url_query"),requestBody:pgCore.text("request_body"),errorMessage:pgCore.text("error_message"),createdAt:pgCore.timestamp("created_at").defaultNow()});var P=pgCore.pgTable("verification_token",{identifier:pgCore.text("identifier").notNull().references(()=>t.email),token:pgCore.text("token"),expiredAt:pgCore.timestamp("expired_at",{mode:"date",withTimezone:true})},e=>[pgCore.primaryKey({columns:[e.identifier,e.token]})]);var qe=pgCore.pgEnum("class_enum",["sesi_1","sesi_2"]),E=pgCore.pgTable("classes",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),className:pgCore.text("class_name").notNull(),room:pgCore.text("room").notNull(),totalQuota:pgCore.integer("total_quota").notNull(),mentorId:pgCore.text("mentor_id").references(()=>t.id),classType:qe("class_type").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),q=pgCore.pgTable("class_registrations",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),userId:pgCore.text("user_id").notNull().references(()=>t.id),classId:pgCore.text("class_id").notNull().references(()=>E.id),registeredAt:pgCore.timestamp("registered_at").defaultNow(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var s=pgCore.pgTable("profil_kats",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),profilNumber:pgCore.integer("profil_number").notNull().unique(),quizWeight:pgCore.real("quiz_weight").notNull().default(0),assignmentWeight:pgCore.real("assignment_weight").notNull().default(0),attendanceWeight:pgCore.real("attendance_weight").notNull().default(0),title:pgCore.text("title").notNull(),description:pgCore.text("description")}),w=pgCore.pgTable("assignments_profil",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),profilKATId:pgCore.text("profil_kat_id").notNull().references(()=>s.id),title:pgCore.text("title").notNull(),assignmentMediaId:pgCore.text("assignment_media_id").notNull().references(()=>_.id),description:pgCore.text("description"),dueDate:pgCore.timestamp("due_date",{mode:"date",withTimezone:true}).notNull(),isOpen:pgCore.boolean("is_open").default(false).notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),f=pgCore.pgTable("submissions_profil",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),assignmentId:pgCore.text("assignment_id").notNull().references(()=>w.id),userId:pgCore.text("user_id").notNull().references(()=>t.id),submissionMediaId:pgCore.text("submission_media_id").notNull().references(()=>_.id),score:pgCore.integer("score").default(0).notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var ze=pgCore.pgEnum("status",["completed","not_completed"]),p=pgCore.pgTable("stages",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),profilId:pgCore.text("profil_id").notNull().references(()=>s.id),stageNumber:pgCore.integer("stage_number").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),C=pgCore.pgTable("user_stage_progress",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),userId:pgCore.text("user_id").notNull().references(()=>t.id),stageId:pgCore.text("stage_id").notNull().references(()=>p.id),status:ze("status").notNull(),completedAt:pgCore.timestamp("completed_at"),quizScore:pgCore.integer("quiz_score"),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var Oe=pgCore.pgEnum("question_type_enum",["multiple_choice","short_answer"]),N=pgCore.pgTable("questions",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),stageId:pgCore.text("stage_id").notNull().references(()=>p.id),questionText:pgCore.text("question_text").notNull(),questionType:Oe("question_type").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),R=pgCore.pgTable("question_answer_options",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),questionId:pgCore.text("question_id").notNull().references(()=>N.id),answerText:pgCore.text("answer_text").notNull(),isCorrect:pgCore.boolean("is_correct").default(false).notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var Ft=pgCore.pgMaterializedView("user_ranking_view",{userId:pgCore.text("user_id").primaryKey(),nim:pgCore.text("nim"),fullName:pgCore.text("full_name"),fakultas:pgCore.text("fakultas"),keluarga:pgCore.text("keluarga"),bata:pgCore.text("bata"),rumpun:pgCore.text("rumpun"),fotoMediaId:pgCore.text("foto_media_id"),profil1QuizWeight:pgCore.real("profil1_quiz_weight").notNull().default(0),profil1QuizScore:pgCore.integer("profil1_quiz_score").notNull().default(0),profil1AssignmentWeight:pgCore.real("profil1_assignment_weight").notNull().default(0),profil1AvgAssignmentScore:pgCore.real("profil1_avg_assignment_score").notNull().default(0),profil1AttendanceWeight:pgCore.real("profil1_attendance_weight").notNull().default(0),profil1AvgAttendanceScore:pgCore.real("profil1_avg_attendance_score").notNull().default(0),profil1TotalScore:pgCore.real("profil1_total_score").notNull().default(0),profil2QuizWeight:pgCore.real("profil2_quiz_weight").notNull().default(0),profil2QuizScore:pgCore.integer("profil2_quiz_score").notNull().default(0),profil2AssignmentWeight:pgCore.real("profil2_assignment_weight").notNull().default(0),profil2AvgAssignmentScore:pgCore.real("profil2_avg_assignment_score").notNull().default(0),profil2AttendanceWeight:pgCore.real("profil2_attendance_weight").notNull().default(0),profil2AvgAttendanceScore:pgCore.real("profil2_avg_attendance_score").notNull().default(0),profil2TotalScore:pgCore.real("profil2_total_score").notNull().default(0),profil3QuizWeight:pgCore.real("profil3_quiz_weight").notNull().default(0),profil3QuizScore:pgCore.integer("profil3_quiz_score").notNull().default(0),profil3AssignmentWeight:pgCore.real("profil3_assignment_weight").notNull().default(0),profil3AvgAssignmentScore:pgCore.real("profil3_avg_assignment_score").notNull().default(0),profil3AttendanceWeight:pgCore.real("profil3_attendance_weight").notNull().default(0),profil3AvgAttendanceScore:pgCore.real("profil3_avg_attendance_score").notNull().default(0),profil3TotalScore:pgCore.real("profil3_total_score").notNull().default(0),profil4QuizWeight:pgCore.real("profil4_quiz_weight").notNull().default(0),profil4QuizScore:pgCore.integer("profil4_quiz_score").notNull().default(0),profil4AssignmentWeight:pgCore.real("profil4_assignment_weight").notNull().default(0),profil4AvgAssignmentScore:pgCore.real("profil4_avg_assignment_score").notNull().default(0),profil4AttendanceWeight:pgCore.real("profil4_attendance_weight").notNull().default(0),profil4AvgAttendanceScore:pgCore.real("profil4_avg_attendance_score").notNull().default(0),profil4TotalScore:pgCore.real("profil4_total_score").notNull().default(0),profil5QuizWeight:pgCore.real("profil5_quiz_weight").notNull().default(0),profil5QuizScore:pgCore.integer("profil5_quiz_score").notNull().default(0),profil5AssignmentWeight:pgCore.real("profil5_assignment_weight").notNull().default(0),profil5AvgAssignmentScore:pgCore.real("profil5_avg_assignment_score").notNull().default(0),profil5AttendanceWeight:pgCore.real("profil5_attendance_weight").notNull().default(0),profil5AvgAttendanceScore:pgCore.real("profil5_avg_attendance_score").notNull().default(0),profil5TotalScore:pgCore.real("profil5_total_score").notNull().default(0),totalScore:pgCore.real("total_score").notNull().default(0),lastActivityAt:pgCore.timestamp("last_activity_at"),ranking:pgCore.integer("ranking").notNull()}).as(drizzleOrm.sql`
  ...
  FROM user_scores
  ORDER BY ranking
`);async function Pt(e){await e.execute(drizzleOrm.sql`REFRESH MATERIALIZED VIEW user_ranking_view`);}var Kt=drizzleOrm.sql`
...
`;var ye=pgCore.pgEnum("attendance_status",["hadir","tidak_hadir"]),Ie=pgCore.pgEnum("attendance_type",["opening","closing"]),g=pgCore.pgTable("attendances",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),attendanceType:Ie("attendance_type").notNull(),dayNumber:pgCore.integer("day_number").notNull(),startTime:pgCore.timestamp("start_time").notNull(),durationMinutes:pgCore.integer("duration_minutes").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),v=pgCore.pgTable("profil_kat_attendance",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),profilKATId:pgCore.text("profil_kat_id").notNull().references(()=>s.id),attendanceId:pgCore.text("attendance_id").notNull().references(()=>g.id),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),O=pgCore.pgTable("user_attendance",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),scheduleId:pgCore.text("schedule_id").notNull().references(()=>g.id),userId:pgCore.text("user_id").notNull().references(()=>t.id),status:ye("status").default("tidak_hadir").notNull(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var fi=pgCore.pgTable("activities",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),day:pgCore.integer("day").notNull(),title:pgCore.text("title").notNull(),description:pgCore.text("description"),startTime:pgCore.time("start_time").notNull(),endTime:pgCore.time("end_time").notNull(),location:pgCore.text("location"),geolocation:pgCore.text("geolocation"),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var Si=drizzleOrm.relations(c,({one:e})=>({user:e(t,{fields:[c.id],references:[t.id]})})),zi=drizzleOrm.relations(t,({one:e,many:o})=>({account:e(c,{fields:[t.id],references:[c.id]}),fotoMedia:e(_,{fields:[t.fotoMediaId],references:[_.id]}),stageProgress:o(C),attendance:o(O),submissions:o(f),createdMedia:o(_),analytics:o(b),classRegistrations:o(q),mentorClasses:o(E)})),Ti=drizzleOrm.relations(F,({one:e})=>({user:e(t,{fields:[F.userId],references:[t.id]})})),vi=drizzleOrm.relations(P,({one:e})=>({user:e(t,{fields:[P.identifier],references:[t.email]})})),Oi=drizzleOrm.relations(_,({one:e,many:o})=>({creator:e(t,{fields:[_.creatorId],references:[t.id]}),submissions:o(f)})),Hi=drizzleOrm.relations(g,({many:e})=>({userAttendance:e(O),profilKATAttendances:e(v)})),xi=drizzleOrm.relations(O,({one:e})=>({attendance:e(g,{fields:[O.scheduleId],references:[g.id]}),user:e(t,{fields:[O.userId],references:[t.id]})})),yi=drizzleOrm.relations(v,({one:e})=>({profilKAT:e(s,{fields:[v.profilKATId],references:[s.id]}),attendance:e(g,{fields:[v.attendanceId],references:[g.id]})})),Ii=drizzleOrm.relations(p,({many:e,one:o})=>({userProgress:e(C),questions:e(N),profil:o(s,{fields:[p.profilId],references:[s.id]})})),ki=drizzleOrm.relations(C,({one:e})=>({user:e(t,{fields:[C.userId],references:[t.id]}),stage:e(p,{fields:[C.stageId],references:[p.id]})})),Li=drizzleOrm.relations(N,({one:e,many:o})=>({stage:e(p,{fields:[N.stageId],references:[p.id]}),answerOptions:o(R)})),bi=drizzleOrm.relations(R,({one:e})=>({question:e(N,{fields:[R.questionId],references:[N.id]})})),Di=drizzleOrm.relations(s,({many:e,one:o})=>({assignments:e(w),attendances:e(v),stage:o(p,{fields:[s.id],references:[p.profilId]})})),Wi=drizzleOrm.relations(w,({many:e,one:o})=>({submissions:e(f),profil:o(s,{fields:[w.profilKATId],references:[s.id]})})),Ri=drizzleOrm.relations(f,({one:e})=>({assignment:e(w,{fields:[f.assignmentId],references:[w.id]}),user:e(t,{fields:[f.userId],references:[t.id]}),media:e(_,{fields:[f.submissionMediaId],references:[_.id]})})),Mi=drizzleOrm.relations(E,({one:e,many:o})=>({mentor:e(t,{fields:[E.mentorId],references:[t.id]}),registrations:o(q)})),Xi=drizzleOrm.relations(q,({one:e})=>({user:e(t,{fields:[q.userId],references:[t.id]}),class:e(E,{fields:[q.classId],references:[E.id]})})),Fi=drizzleOrm.relations(b,({one:e})=>({user:e(t,{fields:[b.userId],references:[t.id]})}));exports.accounts=c;exports.accountsRelation=Si;exports.accountsRoleEnum=le;exports.activities=fi;exports.assignmentsProfil=w;exports.assignmentsProfilRelation=Wi;exports.attendanceStatusEnum=ye;exports.attendanceTypeEnum=Ie;exports.attendances=g;exports.attendancesRelation=Hi;exports.classEnum=qe;exports.classRegistrations=q;exports.classRegistrationsRelation=Xi;exports.classes=E;exports.classesRelation=Mi;exports.createUserRankingViewIndexes=Kt;exports.emailVerificationOtps=F;exports.emailVerificationOtpsRelations=Ti;exports.endpointAnalytics=b;exports.endpointAnalyticsRelation=Fi;exports.media=_;exports.mediaBucketEnum=fe;exports.mediaRelation=Oi;exports.profilKATAttendances=v;exports.profilKATAttendancesRelation=yi;exports.profilKATs=s;exports.profilKATsRelation=Di;exports.questionAnswerOptions=R;exports.questionAnswerOptionsRelation=bi;exports.questionTypeEnum=Oe;exports.questions=N;exports.questionsRelation=Li;exports.refreshUserRankingView=Pt;exports.stageStatusEnum=ze;exports.stages=p;exports.stagesRelation=Ii;exports.submissionsProfil=f;exports.submissionsProfilRelation=Ri;exports.userAttendance=O;exports.userAttendanceRelation=xi;exports.userRankingView=Ft;exports.userStageProgress=C;exports.userStageProgressRelation=ki;exports.users=t;exports.usersRelation=zi;exports.verificationToken=P;exports.verificationTokenRelations=vi;