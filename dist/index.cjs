'use strict';var pgCore=require('drizzle-orm/pg-core'),cuid2=require('@paralleldrive/cuid2'),drizzleOrm=require('drizzle-orm');var a=cuid2.init({length:8}),r=()=>new Date;var le=pgCore.pgEnum("accounts_role_enum",["admin","mamet","mentor","user","guest"]),c=pgCore.pgTable("accounts",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),nim:pgCore.text("nim").notNull().unique(),password:pgCore.text("password").notNull(),role:le("role").default("user").notNull(),lastLoggedIn:pgCore.timestamp("last_logged_in"),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var fe=pgCore.pgEnum("media_bucket_enum",["profile","content","documents","uploads"]),s=pgCore.pgTable("media",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),creatorId:pgCore.text("creator_id").notNull().references(()=>t.id),name:pgCore.text("name").notNull(),bucket:fe("bucket").notNull(),type:pgCore.text("type").notNull(),url:pgCore.text("url").notNull(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r),createdAt:pgCore.timestamp("created_at").defaultNow()});var t=pgCore.pgTable("users",{id:pgCore.text("id").references(()=>c.id).primaryKey(),nim:pgCore.text("nim").notNull().unique(),email:pgCore.text("email").unique(),emailVerified:pgCore.boolean("email_verified").notNull().default(false),fullName:pgCore.text("full_name"),fakultas:pgCore.text("fakultas"),keluarga:pgCore.text("keluarga"),bata:pgCore.text("bata"),rumpun:pgCore.text("rumpun"),fotoMediaId:pgCore.text("foto_media_id").references(()=>s.id),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),U=pgCore.pgTable("email_verification_otps",{userId:pgCore.text("user_id").notNull().references(()=>t.id,{onDelete:"cascade"}),otp:pgCore.text("otp").notNull(),expiresAt:pgCore.timestamp("expires_at",{mode:"date",withTimezone:true}).notNull(),createdAt:pgCore.timestamp("created_at").defaultNow()});var W=pgCore.pgTable("endpoint_analytics",{id:pgCore.serial("id").primaryKey(),userId:pgCore.text("user_id").references(()=>t.id,{onDelete:"set null"}),endpoint:pgCore.text("endpoint").notNull(),method:pgCore.text("method").notNull(),statusCode:pgCore.integer("status_code").notNull(),responseTimeMs:pgCore.integer("response_time_ms"),urlQuery:pgCore.text("url_query"),requestBody:pgCore.text("request_body"),errorMessage:pgCore.text("error_message"),createdAt:pgCore.timestamp("created_at").defaultNow()});var P=pgCore.pgTable("verification_token",{identifier:pgCore.text("identifier").notNull().references(()=>t.email),token:pgCore.text("token").notNull(),expiredAt:pgCore.timestamp("expired_at",{mode:"date",withTimezone:true})},e=>[pgCore.primaryKey({columns:[e.identifier,e.token]})]);var Ce=pgCore.pgEnum("class_enum",["sesi_1","sesi_2"]),E=pgCore.pgTable("classes",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),className:pgCore.text("class_name").notNull(),room:pgCore.text("room").notNull(),totalQuota:pgCore.integer("total_quota").notNull(),mentorId:pgCore.text("mentor_id").references(()=>t.id),classType:Ce("class_type").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),q=pgCore.pgTable("class_registrations",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),userId:pgCore.text("user_id").notNull().references(()=>t.id),classId:pgCore.text("class_id").notNull().references(()=>E.id),registeredAt:pgCore.timestamp("registered_at").defaultNow(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var _=pgCore.pgTable("profil_kats",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),profilNumber:pgCore.integer("profil_number").notNull().unique(),stageWeight:pgCore.real("stage_weight").notNull().default(0),quizWeight:pgCore.real("quiz_weight").notNull().default(0),assignmentWeight:pgCore.real("assignment_weight").notNull().default(0),attendanceWeight:pgCore.real("attendance_weight").notNull().default(0),title:pgCore.text("title").notNull(),description:pgCore.text("description")}),w=pgCore.pgTable("assignments_profil",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),profilKATId:pgCore.text("profil_kat_id").notNull().references(()=>_.id),title:pgCore.text("title").notNull(),assignmentMediaId:pgCore.text("assignment_media_id").notNull().references(()=>s.id),description:pgCore.text("description"),dueDate:pgCore.timestamp("due_date",{mode:"date",withTimezone:true}).notNull(),isOpen:pgCore.boolean("is_open").default(false).notNull(),startDate:pgCore.timestamp("start_date",{mode:"date",withTimezone:true}).notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),f=pgCore.pgTable("submissions_profil",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),assignmentId:pgCore.text("assignment_id").notNull().references(()=>w.id),userId:pgCore.text("user_id").notNull().references(()=>t.id),submissionMediaId:pgCore.text("submission_media_id").notNull().references(()=>s.id),score:pgCore.integer("score").default(0).notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var Te=pgCore.pgEnum("status",["completed","not_completed"]),p=pgCore.pgTable("stages",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),profilId:pgCore.text("profil_id").notNull().references(()=>_.id),stageNumber:pgCore.integer("stage_number").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),T=pgCore.pgTable("user_stage_progress",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),userId:pgCore.text("user_id").notNull().references(()=>t.id),stageId:pgCore.text("stage_id").notNull().references(()=>p.id),status:Te("status").notNull(),completedAt:pgCore.timestamp("completed_at"),quizScore:pgCore.integer("quiz_score"),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var He=pgCore.pgEnum("question_type_enum",["multiple_choice","short_answer"]),N=pgCore.pgTable("questions",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),stageId:pgCore.text("stage_id").notNull().references(()=>p.id),questionText:pgCore.text("question_text").notNull(),questionType:He("question_type").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),R=pgCore.pgTable("question_answer_options",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),questionId:pgCore.text("question_id").notNull().references(()=>N.id),answerText:pgCore.text("answer_text").notNull(),isCorrect:pgCore.boolean("is_correct").default(false).notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var Xt=pgCore.pgMaterializedView("user_ranking_view",{userId:pgCore.text("user_id").primaryKey(),nim:pgCore.text("nim"),fullName:pgCore.text("full_name"),fakultas:pgCore.text("fakultas"),keluarga:pgCore.text("keluarga"),bata:pgCore.text("bata"),rumpun:pgCore.text("rumpun"),fotoMediaId:pgCore.text("foto_media_id"),profil1QuizWeight:pgCore.real("profil1_quiz_weight").notNull().default(0),profil1QuizScore:pgCore.integer("profil1_quiz_score").notNull().default(0),profil1AssignmentWeight:pgCore.real("profil1_assignment_weight").notNull().default(0),profil1AvgAssignmentScore:pgCore.real("profil1_avg_assignment_score").notNull().default(0),profil1AttendanceWeight:pgCore.real("profil1_attendance_weight").notNull().default(0),profil1AvgAttendanceScore:pgCore.real("profil1_avg_attendance_score").notNull().default(0),profil1TotalScore:pgCore.real("profil1_total_score").notNull().default(0),profil2QuizWeight:pgCore.real("profil2_quiz_weight").notNull().default(0),profil2QuizScore:pgCore.integer("profil2_quiz_score").notNull().default(0),profil2AssignmentWeight:pgCore.real("profil2_assignment_weight").notNull().default(0),profil2AvgAssignmentScore:pgCore.real("profil2_avg_assignment_score").notNull().default(0),profil2AttendanceWeight:pgCore.real("profil2_attendance_weight").notNull().default(0),profil2AvgAttendanceScore:pgCore.real("profil2_avg_attendance_score").notNull().default(0),profil2TotalScore:pgCore.real("profil2_total_score").notNull().default(0),profil3QuizWeight:pgCore.real("profil3_quiz_weight").notNull().default(0),profil3QuizScore:pgCore.integer("profil3_quiz_score").notNull().default(0),profil3AssignmentWeight:pgCore.real("profil3_assignment_weight").notNull().default(0),profil3AvgAssignmentScore:pgCore.real("profil3_avg_assignment_score").notNull().default(0),profil3AttendanceWeight:pgCore.real("profil3_attendance_weight").notNull().default(0),profil3AvgAttendanceScore:pgCore.real("profil3_avg_attendance_score").notNull().default(0),profil3TotalScore:pgCore.real("profil3_total_score").notNull().default(0),profil4QuizWeight:pgCore.real("profil4_quiz_weight").notNull().default(0),profil4QuizScore:pgCore.integer("profil4_quiz_score").notNull().default(0),profil4AssignmentWeight:pgCore.real("profil4_assignment_weight").notNull().default(0),profil4AvgAssignmentScore:pgCore.real("profil4_avg_assignment_score").notNull().default(0),profil4AttendanceWeight:pgCore.real("profil4_attendance_weight").notNull().default(0),profil4AvgAttendanceScore:pgCore.real("profil4_avg_attendance_score").notNull().default(0),profil4TotalScore:pgCore.real("profil4_total_score").notNull().default(0),profil5QuizWeight:pgCore.real("profil5_quiz_weight").notNull().default(0),profil5QuizScore:pgCore.integer("profil5_quiz_score").notNull().default(0),profil5AssignmentWeight:pgCore.real("profil5_assignment_weight").notNull().default(0),profil5AvgAssignmentScore:pgCore.real("profil5_avg_assignment_score").notNull().default(0),profil5AttendanceWeight:pgCore.real("profil5_attendance_weight").notNull().default(0),profil5AvgAttendanceScore:pgCore.real("profil5_avg_attendance_score").notNull().default(0),profil5TotalScore:pgCore.real("profil5_total_score").notNull().default(0),totalScore:pgCore.real("total_score").notNull().default(0),totalWeightedScore:pgCore.real("total_weighted_score").notNull().default(0),tiebreakerScore:pgCore.real("tiebreaker_score").notNull().default(0),lastActivityAt:pgCore.timestamp("last_activity_at"),attendanceTotal:pgCore.integer("attendance_total").notNull().default(0),ranking:pgCore.integer("ranking").notNull()}).as(drizzleOrm.sql`
  ...
  FROM user_scores
  ORDER BY ranking
`);async function Ft(e){await e.execute(drizzleOrm.sql`REFRESH MATERIALIZED VIEW CONCURRENTLY user_ranking_view`);}var Ut=drizzleOrm.sql`
...
`;var be=pgCore.pgEnum("attendance_status",["hadir","tidak_hadir"]),ke=pgCore.pgEnum("attendance_type",["opening","closing"]),d=pgCore.pgTable("attendances",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),attendanceType:ke("attendance_type").notNull(),dayNumber:pgCore.integer("day_number").notNull(),startTime:pgCore.timestamp("start_time",{mode:"date",withTimezone:true}).notNull(),durationMinutes:pgCore.integer("duration_minutes").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),H=pgCore.pgTable("profil_kat_attendance",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),profilKATId:pgCore.text("profil_kat_id").notNull().references(()=>_.id),attendanceId:pgCore.text("attendance_id").notNull().references(()=>d.id),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),v=pgCore.pgTable("user_attendance",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),scheduleId:pgCore.text("schedule_id").notNull().references(()=>d.id),userId:pgCore.text("user_id").notNull().references(()=>t.id),status:be("status").default("tidak_hadir").notNull(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var ui=pgCore.pgTable("activities",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),day:pgCore.integer("day").notNull(),title:pgCore.text("title").notNull(),description:pgCore.text("description"),startTime:pgCore.time("start_time").notNull(),endTime:pgCore.time("end_time").notNull(),location:pgCore.text("location"),geolocation:pgCore.text("geolocation"),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var qi=drizzleOrm.relations(c,({one:e})=>({user:e(t,{fields:[c.id],references:[t.id]})})),Si=drizzleOrm.relations(t,({one:e,many:o})=>({account:e(c,{fields:[t.id],references:[c.id]}),fotoMedia:e(s,{fields:[t.fotoMediaId],references:[s.id]}),stageProgress:o(T),attendance:o(v),submissions:o(f),createdMedia:o(s),analytics:o(W),classRegistrations:o(q),mentorClasses:o(E)})),Ti=drizzleOrm.relations(U,({one:e})=>({user:e(t,{fields:[U.userId],references:[t.id]})})),zi=drizzleOrm.relations(P,({one:e})=>({user:e(t,{fields:[P.identifier],references:[t.email]})})),Oi=drizzleOrm.relations(s,({one:e,many:o})=>({creator:e(t,{fields:[s.creatorId],references:[t.id]}),submissions:o(f)})),Hi=drizzleOrm.relations(d,({many:e})=>({userAttendance:e(v),profilKATAttendances:e(H)})),vi=drizzleOrm.relations(v,({one:e})=>({attendance:e(d,{fields:[v.scheduleId],references:[d.id]}),user:e(t,{fields:[v.userId],references:[t.id]})})),Li=drizzleOrm.relations(H,({one:e})=>({profilKAT:e(_,{fields:[H.profilKATId],references:[_.id]}),attendance:e(d,{fields:[H.attendanceId],references:[d.id]})})),bi=drizzleOrm.relations(p,({many:e,one:o})=>({userProgress:e(T),questions:e(N),profil:o(_,{fields:[p.profilId],references:[_.id]})})),ki=drizzleOrm.relations(T,({one:e})=>({user:e(t,{fields:[T.userId],references:[t.id]}),stage:e(p,{fields:[T.stageId],references:[p.id]})})),Di=drizzleOrm.relations(N,({one:e,many:o})=>({stage:e(p,{fields:[N.stageId],references:[p.id]}),answerOptions:o(R)})),Ii=drizzleOrm.relations(R,({one:e})=>({question:e(N,{fields:[R.questionId],references:[N.id]})})),Wi=drizzleOrm.relations(_,({many:e,one:o})=>({assignments:e(w),attendances:e(H),stage:o(p,{fields:[_.id],references:[p.profilId]})})),xi=drizzleOrm.relations(w,({many:e,one:o})=>({submissions:e(f),profil:o(_,{fields:[w.profilKATId],references:[_.id]})})),yi=drizzleOrm.relations(f,({one:e})=>({assignment:e(w,{fields:[f.assignmentId],references:[w.id]}),user:e(t,{fields:[f.userId],references:[t.id]}),media:e(s,{fields:[f.submissionMediaId],references:[s.id]})})),Mi=drizzleOrm.relations(E,({one:e,many:o})=>({mentor:e(t,{fields:[E.mentorId],references:[t.id]}),registrations:o(q)})),Ri=drizzleOrm.relations(q,({one:e})=>({user:e(t,{fields:[q.userId],references:[t.id]}),class:e(E,{fields:[q.classId],references:[E.id]})})),Xi=drizzleOrm.relations(W,({one:e})=>({user:e(t,{fields:[W.userId],references:[t.id]})}));exports.accounts=c;exports.accountsRelation=qi;exports.accountsRoleEnum=le;exports.activities=ui;exports.assignmentsProfil=w;exports.assignmentsProfilRelation=xi;exports.attendanceStatusEnum=be;exports.attendanceTypeEnum=ke;exports.attendances=d;exports.attendancesRelation=Hi;exports.classEnum=Ce;exports.classRegistrations=q;exports.classRegistrationsRelation=Ri;exports.classes=E;exports.classesRelation=Mi;exports.createUserRankingViewIndexes=Ut;exports.emailVerificationOtps=U;exports.emailVerificationOtpsRelations=Ti;exports.endpointAnalytics=W;exports.endpointAnalyticsRelation=Xi;exports.media=s;exports.mediaBucketEnum=fe;exports.mediaRelation=Oi;exports.profilKATAttendances=H;exports.profilKATAttendancesRelation=Li;exports.profilKATs=_;exports.profilKATsRelation=Wi;exports.questionAnswerOptions=R;exports.questionAnswerOptionsRelation=Ii;exports.questionTypeEnum=He;exports.questions=N;exports.questionsRelation=Di;exports.refreshUserRankingView=Ft;exports.stageStatusEnum=Te;exports.stages=p;exports.stagesRelation=bi;exports.submissionsProfil=f;exports.submissionsProfilRelation=yi;exports.userAttendance=v;exports.userAttendanceRelation=vi;exports.userRankingView=Xt;exports.userStageProgress=T;exports.userStageProgressRelation=ki;exports.users=t;exports.usersRelation=Si;exports.verificationToken=P;exports.verificationTokenRelations=zi;