...
`;var ye=pgCore.pgEnum("attendance_status",["hadir","tidak_hadir"]),Me=pgCore.pgEnum("attendance_type",["opening","closing"]),c=pgCore.pgTable("attendances",{id:pgCore.text("id").primaryKey().$defaultFn(()=>s()),attendanceType:Me("attendance_type").notNull(),dayNumber:pgCore.integer("day_number").notNull(),startTime:pgCore.timestamp("start_time",{mode:"date",withTimezone:true}).notNull(),durationMinutes:pgCore.integer("duration_minutes").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)}),v=pgCore.pgTable("profil_kat_attendance",{id:pgCore.text("id").primaryKey().$defaultFn(()=>s()),profilKATId:pgCore.text("profil_kat_id").notNull().references(()=>n.id),attendanceId:pgCore.text("attendance_id").notNull().references(()=>c.id),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)}),L=pgCore.pgTable("user_attendance",{id:pgCore.text("id").primaryKey().$defaultFn(()=>s()),scheduleId:pgCore.text("schedule_id").notNull().references(()=>c.id),userId:pgCore.text("user_id").notNull().references(()=>t.id),status:ye("status").default("tidak_hadir").notNull(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)});var wi=pgCore.pgTable("activities",{id:pgCore.text("id").primaryKey().$defaultFn(()=>s()),day:pgCore.integer("day").notNull(),title:pgCore.text("title").notNull(),description:pgCore.text("description"),startTime:pgCore.time("start_time").notNull(),endTime:pgCore.time("end_time").notNull(),location:pgCore.text("location"),geolocation:pgCore.text("geolocation"),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)});var f=pgCore.pgTable("user_matches",{id:pgCore.text("id").primaryKey().$defaultFn(cuid2.createId),topic:pgCore.text("topic").notNull(),isActive:pgCore.boolean("is_active").notNull().default(true),isAnonymous:pgCore.boolean("is_anonymous").notNull().default(true),isRevealed:pgCore.boolean("is_revealed").notNull().default(false),firstUserId:pgCore.text("first_user_id").notNull().references(()=>t.id,{onDelete:"cascade"}),secondUserId:pgCore.text("second_user_id").notNull().references(()=>t.id,{onDelete:"cascade"}),lastMessage:pgCore.text("last_message"),createdAt:pgCore.timestamp("created_at").defaultNow()}),b=pgCore.pgTable("messages",{id:pgCore.bigserial("id",{mode:"number"}).primaryKey(),userMatchId:pgCore.text("user_match_id").notNull().references(()=>f.id,{onDelete:"cascade"}),senderId:pgCore.text("sender_id").notNull().references(()=>t.id,{onDelete:"cascade"}),content:pgCore.text("content").notNull(),createdAt:pgCore.timestamp("created_at",{mode:"date",withTimezone:true})});var Mi=drizzleOrm.relations(E,({one:e})=>({user:e(t,{fields:[E.id],references:[t.id]})})),Ri=drizzleOrm.relations(t,({one:e,many:r})=>({account:e(E,{fields:[t.id],references:[E.id]}),fotoMedia:e(_,{fields:[t.fotoMediaId],references:[_.id]}),stageProgress:r(z),attendance:r(L),submissions:r(g),createdMedia:r(_),analytics:r(M),classRegistrations:r(S),userMatchesAsFirstUser:r(f,{relationName:"first_user"}),userMatchesAsSecondUser:r(f,{relationName:"second_user"}),messages:r(b,{relationName:"sender"})})),Xi=drizzleOrm.relations($,({one:e})=>({user:e(t,{fields:[$.userId],references:[t.id]})})),Ui=drizzleOrm.relations(J,({one:e})=>({user:e(t,{fields:[J.identifier],references:[t.email]})})),Fi=drizzleOrm.relations(_,({one:e,many:r})=>({creator:e(t,{fields:[_.creatorId],references:[t.id]}),submissions:r(g)})),Pi=drizzleOrm.relations(c,({many:e})=>({userAttendance:e(L),profilKATAttendances:e(v)})),Ki=drizzleOrm.relations(L,({one:e})=>({attendance:e(c,{fields:[L.scheduleId],references:[c.id]}),user:e(t,{fields:[L.userId],references:[t.id]})})),$i=drizzleOrm.relations(v,({one:e})=>({profilKAT:e(n,{fields:[v.profilKATId],references:[n.id]}),attendance:e(c,{fields:[v.attendanceId],references:[c.id]})})),Ji=drizzleOrm.relations(u,({many:e,one:r})=>({userProgress:e(z),questions:e(h),profil:r(n,{fields:[u.profilId],references:[n.id]})})),Gi=drizzleOrm.relations(z,({one:e})=>({user:e(t,{fields:[z.userId],references:[t.id]}),stage:e(u,{fields:[z.stageId],references:[u.id]})})),Qi=drizzleOrm.relations(h,({one:e,many:r})=>({stage:e(u,{fields:[h.stageId],references:[u.id]}),answerOptions:r(F)})),Vi=drizzleOrm.relations(F,({one:e})=>({question:e(h,{fields:[F.questionId],references:[h.id]})})),Bi=drizzleOrm.relations(n,({many:e,one:r})=>({assignments:e(w),attendances:e(v),stage:r(u,{fields:[n.id],references:[u.profilId]})})),Yi=drizzleOrm.relations(w,({many:e,one:r})=>({submissions:e(g),profil:r(n,{fields:[w.profilKATId],references:[n.id]})})),Zi=drizzleOrm.relations(g,({one:e})=>({assignment:e(w,{fields:[g.assignmentId],references:[w.id]}),user:e(t,{fields:[g.userId],references:[t.id]}),media:e(_,{fields:[g.submissionMediaId],references:[_.id]})})),ji=drizzleOrm.relations(k,({one:e,many:r})=>({registrations:r(S)})),er=drizzleOrm.relations(S,({one:e})=>({user:e(t,{fields:[S.userId],references:[t.id]}),class:e(k,{fields:[S.classId],references:[k.id]})})),tr=drizzleOrm.relations(M,({one:e})=>({user:e(t,{fields:[M.userId],references:[t.id]})})),ir=drizzleOrm.relations(f,({many:e,one:r})=>({firstUser:r(t,{fields:[f.firstUserId],references:[t.id],relationName:"first_user"}),secondUser:r(t,{fields:[f.secondUserId],references:[t.id],relationName:"second_user"}),messages:e(b)})),rr=drizzleOrm.relations(b,({one:e})=>({senderId:e(t,{fields:[b.senderId],references:[t.id],relationName:"sender"}),userMatch:e(f,{fields:[b.userMatchId],references:[f.id]})}));exports.accounts=E;exports.accountsRelation=Mi;exports.accountsRoleEnum=ce;exports.activities=wi;exports.assignmentsProfil=w;exports.assignmentsProfilRelation=Yi;exports.attendanceStatusEnum=ye;exports.attendanceTypeEnum=Me;exports.attendances=c;exports.attendancesRelation=Pi;exports.classEnum=He;exports.classRegistrations=S;exports.classRegistrationsRelation=er;exports.classes=k;exports.classesRelation=ji;exports.createUserRankingViewIndexes=Bt;exports.emailVerificationOtps=$;exports.emailVerificationOtpsRelations=Xi;exports.endpointAnalytics=M;exports.endpointAnalyticsRelation=tr;exports.media=_;exports.mediaBucketEnum=Ne;exports.mediaRelation=Fi;exports.messages=b;exports.messagesRelations=rr;exports.profilKATAttendances=v;exports.profilKATAttendancesRelation=$i;exports.profilKATs=n;exports.profilKATsRelation=Bi;exports.questionAnswerOptions=F;exports.questionAnswerOptionsRelation=Vi;exports.questionTypeEnum=ke;exports.questions=h;exports.questionsRelation=Qi;exports.refreshUserRankingView=Vt;exports.stageStatusEnum=be;exports.stages=u;exports.stagesRelation=Ji;exports.submissionsProfil=g;exports.submissionsProfilRelation=Zi;exports.userAttendance=L;exports.userAttendanceRelation=Ki;exports.userMatches=f;exports.userMatchesRelations=ir;exports.userRankingView=Qt;exports.userStageProgress=z;exports.userStageProgressRelation=Gi;exports.users=t;exports.usersRelation=Ri;exports.verificationToken=J;exports.verificationTokenRelations=Ui;