...
`;var Ke=pgCore.pgEnum("attendance_status",["hadir","tidak_hadir"]),$e=pgCore.pgEnum("attendance_type",["opening","closing"]),E=pgCore.pgTable("attendances",{id:pgCore.text("id").primaryKey().$defaultFn(()=>s()),attendanceType:$e("attendance_type").notNull(),dayNumber:pgCore.integer("day_number").notNull(),startTime:pgCore.timestamp("start_time",{mode:"date",withTimezone:true}).notNull(),durationMinutes:pgCore.integer("duration_minutes").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)}),L=pgCore.pgTable("profil_kat_attendance",{id:pgCore.text("id").primaryKey().$defaultFn(()=>s()),profilKATId:pgCore.text("profil_kat_id").notNull().references(()=>_.id),attendanceId:pgCore.text("attendance_id").notNull().references(()=>E.id),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)}),I=pgCore.pgTable("user_attendance",{id:pgCore.text("id").primaryKey().$defaultFn(()=>s()),scheduleId:pgCore.text("schedule_id").notNull().references(()=>E.id),userId:pgCore.text("user_id").notNull().references(()=>t.id),status:Ke("status").default("tidak_hadir").notNull(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)});var Qe=pgCore.pgEnum("itb_guesser_tempat",["Ganesha","Jatinangor","Cirebon"]),y=pgCore.pgTable("itb_guesser_options",{id:pgCore.text("id").primaryKey().$defaultFn(()=>s()),tempat:Qe("tempat").notNull(),publicUrl:pgCore.text("public_url").notNull(),lat:pgCore.real("lat").notNull(),lng:pgCore.real("lng").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)}),k=pgCore.pgTable("itb_guesser_submissions",{id:pgCore.text("id").primaryKey().$defaultFn(()=>s()),userId:pgCore.text("user_id").notNull().references(()=>t.id),optionId:pgCore.text("option_id").notNull().references(()=>y.id),answerLat:pgCore.real("answer_lat").notNull(),answerLng:pgCore.real("answer_lng").notNull(),score:pgCore.real("score").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)}),qi=pgCore.pgTable("memory_game_scores",{id:pgCore.text("id").primaryKey().$defaultFn(()=>s()),userId:pgCore.text("user_id").notNull().unique().references(()=>t.id),score:pgCore.integer("score").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)});var ie=pgCore.pgTable("handbook",{mediaId:pgCore.text("media_id").primaryKey().references(()=>n.id),title:pgCore.text("title")});var Ui=pgCore.pgTable("activities",{id:pgCore.text("id").primaryKey().$defaultFn(()=>s()),day:pgCore.integer("day").notNull(),title:pgCore.text("title").notNull(),description:pgCore.text("description"),startTime:pgCore.time("start_time").notNull(),endTime:pgCore.time("end_time").notNull(),location:pgCore.text("location"),lat:pgCore.real("lat"),lng:pgCore.real("lng"),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(a)});var f=pgCore.pgTable("user_matches",{id:pgCore.text("id").primaryKey().$defaultFn(cuid2.createId),topic:pgCore.text("topic").notNull(),isActive:pgCore.boolean("is_active").notNull().default(true),isAnonymous:pgCore.boolean("is_anonymous").notNull().default(true),isRevealed:pgCore.boolean("is_revealed").notNull().default(false),firstUserId:pgCore.text("first_user_id").notNull().references(()=>t.id,{onDelete:"cascade"}),secondUserId:pgCore.text("second_user_id").notNull().references(()=>t.id,{onDelete:"cascade"}),lastMessage:pgCore.text("last_message"),createdAt:pgCore.timestamp("created_at").notNull().defaultNow()}),D=pgCore.pgTable("messages",{id:pgCore.bigserial("id",{mode:"number"}).primaryKey(),userMatchId:pgCore.text("user_match_id").notNull().references(()=>f.id,{onDelete:"cascade"}),senderId:pgCore.text("sender_id").notNull().references(()=>t.id,{onDelete:"cascade"}),content:pgCore.text("content").notNull(),createdAt:pgCore.timestamp("created_at",{mode:"date",withTimezone:true}).notNull().defaultNow()});var or=drizzleOrm.relations(w,({one:e})=>({user:e(t,{fields:[w.id],references:[t.id]})})),nr=drizzleOrm.relations(t,({one:e,many:r})=>({account:e(w,{fields:[t.id],references:[w.id]}),fotoMedia:e(n,{fields:[t.fotoMediaId],references:[n.id]}),stageProgress:r(b),attendance:r(I),submissions:r(d),createdMedia:r(n),analytics:r(F),classRegistrations:r(z),userMatchesAsFirstUser:r(f,{relationName:"first_user"}),userMatchesAsSecondUser:r(f,{relationName:"second_user"}),messages:r(D,{relationName:"sender"}),itbGuesserSubmissions:r(k)})),_r=drizzleOrm.relations(B,({one:e})=>({user:e(t,{fields:[B.userId],references:[t.id]})})),lr=drizzleOrm.relations(Y,({one:e})=>({user:e(t,{fields:[Y.identifier],references:[t.email]})})),ur=drizzleOrm.relations(n,({one:e,many:r})=>({creator:e(t,{fields:[n.creatorId],references:[t.id]}),handbook:e(ie,{fields:[n.id],references:[ie.mediaId]}),submissions:r(d),itbGuesserOptions:r(y)})),pr=drizzleOrm.relations(E,({many:e})=>({userAttendance:e(I),profilKATAttendances:e(L)})),fr=drizzleOrm.relations(I,({one:e})=>({attendance:e(E,{fields:[I.scheduleId],references:[E.id]}),user:e(t,{fields:[I.userId],references:[t.id]})})),gr=drizzleOrm.relations(L,({one:e})=>({profilKAT:e(_,{fields:[L.profilKATId],references:[_.id]}),attendance:e(E,{fields:[L.attendanceId],references:[E.id]})})),dr=drizzleOrm.relations(u,({many:e,one:r})=>({userProgress:e(b),questions:e(A),profil:r(_,{fields:[u.profilId],references:[_.id]})})),cr=drizzleOrm.relations(b,({one:e})=>({user:e(t,{fields:[b.userId],references:[t.id]}),stage:e(u,{fields:[b.stageId],references:[u.id]})})),mr=drizzleOrm.relations(A,({one:e,many:r})=>({stage:e(u,{fields:[A.stageId],references:[u.id]}),answerOptions:r(G)})),Er=drizzleOrm.relations(G,({one:e})=>({question:e(A,{fields:[G.questionId],references:[A.id]})})),Nr=drizzleOrm.relations(_,({many:e,one:r})=>({assignments:e(h),attendances:e(L),stage:r(u,{fields:[_.id],references:[u.profilId]})})),wr=drizzleOrm.relations(h,({many:e,one:r})=>({submissions:e(d),profil:r(_,{fields:[h.profilKATId],references:[_.id]})})),hr=drizzleOrm.relations(d,({one:e})=>({assignment:e(h,{fields:[d.assignmentId],references:[h.id]}),user:e(t,{fields:[d.userId],references:[t.id]}),media:e(n,{fields:[d.submissionMediaId],references:[n.id]})})),Ar=drizzleOrm.relations(M,({one:e,many:r})=>({registrations:r(z)})),Cr=drizzleOrm.relations(z,({one:e})=>({user:e(t,{fields:[z.userId],references:[t.id]}),class:e(M,{fields:[z.classId],references:[M.id]})})),Sr=drizzleOrm.relations(F,({one:e})=>({user:e(t,{fields:[F.userId],references:[t.id]})})),qr=drizzleOrm.relations(f,({many:e,one:r})=>({firstUser:r(t,{fields:[f.firstUserId],references:[t.id],relationName:"first_user"}),secondUser:r(t,{fields:[f.secondUserId],references:[t.id],relationName:"second_user"}),messages:e(D)})),Tr=drizzleOrm.relations(D,({one:e})=>({senderId:e(t,{fields:[D.senderId],references:[t.id],relationName:"sender"}),userMatch:e(f,{fields:[D.userMatchId],references:[f.id]})})),zr=drizzleOrm.relations(y,({one:e,many:r})=>({submissions:r(k)})),Or=drizzleOrm.relations(k,({one:e})=>({user:e(t,{fields:[k.userId],references:[t.id]}),option:e(y,{fields:[k.optionId],references:[y.id]})}));exports.accounts=w;exports.accountsRelation=or;exports.accountsRoleEnum=qe;exports.activities=Ui;exports.assignmentsProfil=h;exports.assignmentsProfilRelation=wr;exports.attendanceStatusEnum=Ke;exports.attendanceTypeEnum=$e;exports.attendances=E;exports.attendancesRelation=pr;exports.classEnum=ke;exports.classRegistrations=z;exports.classRegistrationsRelation=Cr;exports.classes=M;exports.classesRelation=Ar;exports.createUserRankingViewIndexes=_i;exports.emailVerificationOtps=B;exports.emailVerificationOtpsRelations=_r;exports.endpointAnalytics=F;exports.endpointAnalyticsRelation=Sr;exports.handbook=ie;exports.itbGuesserOptions=y;exports.itbGuesserOptionsRelations=zr;exports.itbGuesserSubmissions=k;exports.itbGuesserSubmissionsRelations=Or;exports.itbGuesserTempatEnum=Qe;exports.media=n;exports.mediaRelation=ur;exports.memoryGameScores=qi;exports.messages=D;exports.messagesRelations=Tr;exports.profilKATAttendances=L;exports.profilKATAttendancesRelation=gr;exports.profilKATs=_;exports.profilKATsRelation=Nr;exports.questionAnswerOptions=G;exports.questionAnswerOptionsRelation=Er;exports.questionTypeEnum=Ue;exports.questions=A;exports.questionsRelation=mr;exports.refreshUserRankingView=ni;exports.stageStatusEnum=Me;exports.stages=u;exports.stagesRelation=dr;exports.submissionsProfil=d;exports.submissionsProfilRelation=hr;exports.userAttendance=I;exports.userAttendanceRelation=fr;exports.userMatches=f;exports.userMatchesRelations=qr;exports.userRankingView=oi;exports.userStageProgress=b;exports.userStageProgressRelation=cr;exports.users=t;exports.usersRelation=nr;exports.verificationToken=Y;exports.verificationTokenRelations=lr;