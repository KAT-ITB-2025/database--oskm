...
`;var Ke=pgCore.pgEnum("attendance_status",["hadir","tidak_hadir"]),$e=pgCore.pgEnum("attendance_type",["opening","closing"]),E=pgCore.pgTable("attendances",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),attendanceType:$e("attendance_type").notNull(),dayNumber:pgCore.integer("day_number").notNull(),startTime:pgCore.timestamp("start_time",{mode:"date",withTimezone:true}).notNull(),durationMinutes:pgCore.integer("duration_minutes").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),v=pgCore.pgTable("profil_kat_attendance",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),profilKATId:pgCore.text("profil_kat_id").notNull().references(()=>_.id),attendanceId:pgCore.text("attendance_id").notNull().references(()=>E.id),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),L=pgCore.pgTable("user_attendance",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),scheduleId:pgCore.text("schedule_id").notNull().references(()=>E.id),userId:pgCore.text("user_id").notNull().references(()=>t.id),status:Ke("status").default("tidak_hadir").notNull(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var Qe=pgCore.pgEnum("itb_guesser_tempat",["Ganesha","Jatinangor","Cirebon"]),de=pgCore.pgTable("itb_guesser_options",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),tempat:Qe("tempat").notNull(),publicUrl:pgCore.text("public_url").notNull(),lat:pgCore.real("lat").notNull(),lng:pgCore.real("lng").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),K=pgCore.pgTable("itb_guesser_submissions",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),userId:pgCore.text("user_id").notNull().references(()=>t.id),score:pgCore.real("score").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),Ti=pgCore.pgTable("memory_game_scores",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),userId:pgCore.text("user_id").notNull().unique().references(()=>t.id),score:pgCore.integer("score").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var te=pgCore.pgTable("handbook",{mediaId:pgCore.text("media_id").primaryKey().references(()=>n.id),title:pgCore.text("title")});var Fi=pgCore.pgTable("activities",{id:pgCore.text("id").primaryKey().$defaultFn(()=>a()),day:pgCore.integer("day").notNull(),title:pgCore.text("title").notNull(),description:pgCore.text("description"),startTime:pgCore.time("start_time").notNull(),endTime:pgCore.time("end_time").notNull(),location:pgCore.text("location"),lat:pgCore.real("lat"),lng:pgCore.real("lng"),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var f=pgCore.pgTable("user_matches",{id:pgCore.text("id").primaryKey().$defaultFn(cuid2.createId),topic:pgCore.text("topic").notNull(),isActive:pgCore.boolean("is_active").notNull().default(true),isAnonymous:pgCore.boolean("is_anonymous").notNull().default(true),isRevealed:pgCore.boolean("is_revealed").notNull().default(false),firstUserId:pgCore.text("first_user_id").notNull().references(()=>t.id,{onDelete:"cascade"}),secondUserId:pgCore.text("second_user_id").notNull().references(()=>t.id,{onDelete:"cascade"}),lastMessage:pgCore.text("last_message"),createdAt:pgCore.timestamp("created_at").notNull().defaultNow()}),y=pgCore.pgTable("messages",{id:pgCore.bigserial("id",{mode:"number"}).primaryKey(),userMatchId:pgCore.text("user_match_id").notNull().references(()=>f.id,{onDelete:"cascade"}),senderId:pgCore.text("sender_id").notNull().references(()=>t.id,{onDelete:"cascade"}),content:pgCore.text("content").notNull(),createdAt:pgCore.timestamp("created_at",{mode:"date",withTimezone:true}).notNull().defaultNow()});var nr=drizzleOrm.relations(w,({one:e})=>({user:e(t,{fields:[w.id],references:[t.id]})})),_r=drizzleOrm.relations(t,({one:e,many:s})=>({account:e(w,{fields:[t.id],references:[w.id]}),fotoMedia:e(n,{fields:[t.fotoMediaId],references:[n.id]}),stageProgress:s(O),attendance:s(L),submissions:s(d),createdMedia:s(n),analytics:s(R),classRegistrations:s(T),userMatchesAsFirstUser:s(f,{relationName:"first_user"}),userMatchesAsSecondUser:s(f,{relationName:"second_user"}),messages:s(y,{relationName:"sender"}),itbGuesserSubmissions:s(K)})),lr=drizzleOrm.relations(Q,({one:e})=>({user:e(t,{fields:[Q.userId],references:[t.id]})})),ur=drizzleOrm.relations(V,({one:e})=>({user:e(t,{fields:[V.identifier],references:[t.email]})})),pr=drizzleOrm.relations(n,({one:e,many:s})=>({creator:e(t,{fields:[n.creatorId],references:[t.id]}),handbook:e(te,{fields:[n.id],references:[te.mediaId]}),submissions:s(d),itbGuesserOptions:s(de)})),fr=drizzleOrm.relations(E,({many:e})=>({userAttendance:e(L),profilKATAttendances:e(v)})),gr=drizzleOrm.relations(L,({one:e})=>({attendance:e(E,{fields:[L.scheduleId],references:[E.id]}),user:e(t,{fields:[L.userId],references:[t.id]})})),dr=drizzleOrm.relations(v,({one:e})=>({profilKAT:e(_,{fields:[v.profilKATId],references:[_.id]}),attendance:e(E,{fields:[v.attendanceId],references:[E.id]})})),cr=drizzleOrm.relations(u,({many:e,one:s})=>({userProgress:e(O),questions:e(A),profil:s(_,{fields:[u.profilId],references:[_.id]})})),mr=drizzleOrm.relations(O,({one:e})=>({user:e(t,{fields:[O.userId],references:[t.id]}),stage:e(u,{fields:[O.stageId],references:[u.id]})})),Er=drizzleOrm.relations(A,({one:e,many:s})=>({stage:e(u,{fields:[A.stageId],references:[u.id]}),answerOptions:s(P)})),Nr=drizzleOrm.relations(P,({one:e})=>({question:e(A,{fields:[P.questionId],references:[A.id]})})),wr=drizzleOrm.relations(_,({many:e,one:s})=>({assignments:e(h),attendances:e(v),stage:s(u,{fields:[_.id],references:[u.profilId]})})),hr=drizzleOrm.relations(h,({many:e,one:s})=>({submissions:e(d),profil:s(_,{fields:[h.profilKATId],references:[_.id]})})),Ar=drizzleOrm.relations(d,({one:e})=>({assignment:e(h,{fields:[d.assignmentId],references:[h.id]}),user:e(t,{fields:[d.userId],references:[t.id]}),media:e(n,{fields:[d.submissionMediaId],references:[n.id]})})),Cr=drizzleOrm.relations(D,({one:e,many:s})=>({registrations:s(T)})),Sr=drizzleOrm.relations(T,({one:e})=>({user:e(t,{fields:[T.userId],references:[t.id]}),class:e(D,{fields:[T.classId],references:[D.id]})})),qr=drizzleOrm.relations(R,({one:e})=>({user:e(t,{fields:[R.userId],references:[t.id]})})),Tr=drizzleOrm.relations(f,({many:e,one:s})=>({firstUser:s(t,{fields:[f.firstUserId],references:[t.id],relationName:"first_user"}),secondUser:s(t,{fields:[f.secondUserId],references:[t.id],relationName:"second_user"}),messages:e(y)})),zr=drizzleOrm.relations(y,({one:e})=>({senderId:e(t,{fields:[y.senderId],references:[t.id],relationName:"sender"}),userMatch:e(f,{fields:[y.userMatchId],references:[f.id]})})),Or=drizzleOrm.relations(K,({one:e})=>({user:e(t,{fields:[K.userId],references:[t.id]})}));exports.accounts=w;exports.accountsRelation=nr;exports.accountsRoleEnum=qe;exports.activities=Fi;exports.assignmentsProfil=h;exports.assignmentsProfilRelation=hr;exports.attendanceStatusEnum=Ke;exports.attendanceTypeEnum=$e;exports.attendances=E;exports.attendancesRelation=fr;exports.classEnum=ke;exports.classRegistrations=T;exports.classRegistrationsRelation=Sr;exports.classes=D;exports.classesRelation=Cr;exports.createUserRankingViewIndexes=li;exports.emailVerificationOtps=Q;exports.emailVerificationOtpsRelations=lr;exports.endpointAnalytics=R;exports.endpointAnalyticsRelation=qr;exports.handbook=te;exports.itbGuesserOptions=de;exports.itbGuesserSubmissions=K;exports.itbGuesserSubmissionsRelations=Or;exports.itbGuesserTempatEnum=Qe;exports.media=n;exports.mediaRelation=pr;exports.memoryGameScores=Ti;exports.messages=y;exports.messagesRelations=zr;exports.profilKATAttendances=v;exports.profilKATAttendancesRelation=dr;exports.profilKATs=_;exports.profilKATsRelation=wr;exports.questionAnswerOptions=P;exports.questionAnswerOptionsRelation=Nr;exports.questionTypeEnum=Ue;exports.questions=A;exports.questionsRelation=Er;exports.refreshUserRankingView=_i;exports.stageStatusEnum=Me;exports.stages=u;exports.stagesRelation=cr;exports.submissionsProfil=d;exports.submissionsProfilRelation=Ar;exports.userAttendance=L;exports.userAttendanceRelation=gr;exports.userMatches=f;exports.userMatchesRelations=Tr;exports.userRankingView=ni;exports.userStageProgress=O;exports.userStageProgressRelation=mr;exports.users=t;exports.usersRelation=_r;exports.verificationToken=V;exports.verificationTokenRelations=ur;