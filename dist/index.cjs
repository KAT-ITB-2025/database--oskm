...
`;var We=pgCore.pgEnum("attendance_status",["hadir","tidak_hadir"]),Me=pgCore.pgEnum("attendance_type",["opening","closing"]),d=pgCore.pgTable("attendances",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),attendanceType:Me("attendance_type").notNull(),dayNumber:pgCore.integer("day_number").notNull(),startTime:pgCore.timestamp("start_time",{mode:"date",withTimezone:true}).notNull(),durationMinutes:pgCore.integer("duration_minutes").notNull(),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),L=pgCore.pgTable("profil_kat_attendance",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),profilKATId:pgCore.text("profil_kat_id").notNull().references(()=>n.id),attendanceId:pgCore.text("attendance_id").notNull().references(()=>d.id),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)}),b=pgCore.pgTable("user_attendance",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),scheduleId:pgCore.text("schedule_id").notNull().references(()=>d.id),userId:pgCore.text("user_id").notNull().references(()=>t.id),status:We("status").default("tidak_hadir").notNull(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var wi=pgCore.pgTable("activities",{id:pgCore.text("id").primaryKey().$defaultFn(()=>o()),day:pgCore.integer("day").notNull(),title:pgCore.text("title").notNull(),description:pgCore.text("description"),startTime:pgCore.time("start_time").notNull(),endTime:pgCore.time("end_time").notNull(),location:pgCore.text("location"),geolocation:pgCore.text("geolocation"),createdAt:pgCore.timestamp("created_at").defaultNow(),updatedAt:pgCore.timestamp("updated_at").$onUpdate(r)});var m=pgCore.pgTable("user_matches",{id:pgCore.text("id").primaryKey().$defaultFn(cuid2.createId),topic:pgCore.text("topic").notNull(),isActive:pgCore.boolean("is_active").notNull().default(true),isAnonymous:pgCore.boolean("is_anonymous").notNull().default(true),isRevealed:pgCore.boolean("is_revealed").notNull().default(false),firstUserId:pgCore.text("first_user_id").references(()=>t.id,{onDelete:"cascade"}),secondUserId:pgCore.text("second_user_id").references(()=>t.id,{onDelete:"cascade"}),lastMessage:pgCore.text("last_message"),createdAt:pgCore.timestamp("created_at").defaultNow()}),y=pgCore.pgTable("messages",{id:pgCore.bigserial("id",{mode:"number"}).primaryKey(),userMatchId:pgCore.text("user_match_id").references(()=>m.id,{onDelete:"cascade"}),senderId:pgCore.text("sender_id").references(()=>t.id,{onDelete:"cascade"}),content:pgCore.text("content").notNull(),createdAt:pgCore.timestamp("created_at",{mode:"date",withTimezone:true})});var Mi=drizzleOrm.relations(E,({one:e})=>({user:e(t,{fields:[E.id],references:[t.id]})})),Ri=drizzleOrm.relations(t,({one:e,many:a})=>({account:e(E,{fields:[t.id],references:[E.id]}),fotoMedia:e(_,{fields:[t.fotoMediaId],references:[_.id]}),stageProgress:a(O),attendance:a(b),submissions:a(f),createdMedia:a(_),analytics:a(M),classRegistrations:a(T),mentorClasses:a(w),userMatches:a(m)})),Xi=drizzleOrm.relations($,({one:e})=>({user:e(t,{fields:[$.userId],references:[t.id]})})),Ui=drizzleOrm.relations(J,({one:e})=>({user:e(t,{fields:[J.identifier],references:[t.email]})})),Fi=drizzleOrm.relations(_,({one:e,many:a})=>({creator:e(t,{fields:[_.creatorId],references:[t.id]}),submissions:a(f)})),Pi=drizzleOrm.relations(d,({many:e})=>({userAttendance:e(b),profilKATAttendances:e(L)})),Ki=drizzleOrm.relations(b,({one:e})=>({attendance:e(d,{fields:[b.scheduleId],references:[d.id]}),user:e(t,{fields:[b.userId],references:[t.id]})})),$i=drizzleOrm.relations(L,({one:e})=>({profilKAT:e(n,{fields:[L.profilKATId],references:[n.id]}),attendance:e(d,{fields:[L.attendanceId],references:[d.id]})})),Ji=drizzleOrm.relations(p,({many:e,one:a})=>({userProgress:e(O),questions:e(A),profil:a(n,{fields:[p.profilId],references:[n.id]})})),Gi=drizzleOrm.relations(O,({one:e})=>({user:e(t,{fields:[O.userId],references:[t.id]}),stage:e(p,{fields:[O.stageId],references:[p.id]})})),Qi=drizzleOrm.relations(A,({one:e,many:a})=>({stage:e(p,{fields:[A.stageId],references:[p.id]}),answerOptions:a(F)})),Vi=drizzleOrm.relations(F,({one:e})=>({question:e(A,{fields:[F.questionId],references:[A.id]})})),Bi=drizzleOrm.relations(n,({many:e,one:a})=>({assignments:e(h),attendances:e(L),stage:a(p,{fields:[n.id],references:[p.profilId]})})),Yi=drizzleOrm.relations(h,({many:e,one:a})=>({submissions:e(f),profil:a(n,{fields:[h.profilKATId],references:[n.id]})})),Zi=drizzleOrm.relations(f,({one:e})=>({assignment:e(h,{fields:[f.assignmentId],references:[h.id]}),user:e(t,{fields:[f.userId],references:[t.id]}),media:e(_,{fields:[f.submissionMediaId],references:[_.id]})})),ji=drizzleOrm.relations(w,({one:e,many:a})=>({mentor:e(t,{fields:[w.mentorId],references:[t.id]}),registrations:a(T)})),er=drizzleOrm.relations(T,({one:e})=>({user:e(t,{fields:[T.userId],references:[t.id]}),class:e(w,{fields:[T.classId],references:[w.id]})})),tr=drizzleOrm.relations(M,({one:e})=>({user:e(t,{fields:[M.userId],references:[t.id]})})),ir=drizzleOrm.relations(m,({many:e,one:a})=>({firstUser:a(t,{fields:[m.firstUserId],references:[t.id],relationName:"first_user"}),secondUser:a(t,{fields:[m.secondUserId],references:[t.id],relationName:"second_user"}),messages:e(y)})),rr=drizzleOrm.relations(y,({one:e})=>({senderId:e(t,{fields:[y.senderId],references:[t.id]}),userMatch:e(m,{fields:[y.userMatchId],references:[m.id]})}));exports.accounts=E;exports.accountsRelation=Mi;exports.accountsRoleEnum=ce;exports.activities=wi;exports.assignmentsProfil=h;exports.assignmentsProfilRelation=Yi;exports.attendanceStatusEnum=We;exports.attendanceTypeEnum=Me;exports.attendances=d;exports.attendancesRelation=Pi;exports.classEnum=He;exports.classRegistrations=T;exports.classRegistrationsRelation=er;exports.classes=w;exports.classesRelation=ji;exports.createUserRankingViewIndexes=Bt;exports.emailVerificationOtps=$;exports.emailVerificationOtpsRelations=Xi;exports.endpointAnalytics=M;exports.endpointAnalyticsRelation=tr;exports.media=_;exports.mediaBucketEnum=Ne;exports.mediaRelation=Fi;exports.messagesRelations=rr;exports.profilKATAttendances=L;exports.profilKATAttendancesRelation=$i;exports.profilKATs=n;exports.profilKATsRelation=Bi;exports.questionAnswerOptions=F;exports.questionAnswerOptionsRelation=Vi;exports.questionTypeEnum=De;exports.questions=A;exports.questionsRelation=Qi;exports.refreshUserRankingView=Vt;exports.stageStatusEnum=be;exports.stages=p;exports.stagesRelation=Ji;exports.submissionsProfil=f;exports.submissionsProfilRelation=Zi;exports.userAttendance=b;exports.userAttendanceRelation=Ki;exports.userMatchesRelations=ir;exports.userRankingView=Qt;exports.userStageProgress=O;exports.userStageProgressRelation=Gi;exports.users=t;exports.usersRelation=Ri;exports.verificationToken=J;exports.verificationTokenRelations=Ui;