...
ALTER TABLE "attendances" ADD COLUMN "attendance_type" "attendance_type" NOT NULL;--> statement-breakpoint
ALTER TABLE "profil_kats" ADD COLUMN "quiz_weight" real DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "profil_kats" ADD COLUMN "assignment_weight" real DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "profil_kats" ADD COLUMN "attendance_weight" real DEFAULT 0 NOT NULL;--> statement-breakpoint
...
ALTER TABLE "attendances" DROP COLUMN "title";--> statement-breakpoint
ALTER TABLE "attendances" DROP COLUMN "description";--> statement-breakpoint
ALTER TABLE "stages" DROP COLUMN "quiz_weight";--> statement-breakpoint
